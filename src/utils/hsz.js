...
const hsz = {
  ...
  getDate (format, strInterval, number) {
    ...
    return hsz.toDate(myDate, format);
  },
  toDate (v, format) {
    ...
    if (childNode.length > 0) {
      for (let i = 0; i < childNode.length; i++) {
        let treeModel = {
          ...
          ChildNodes: hsz.toTreeViewJson(data, childNode[i][idText], parentIdText, idText),
  ...
  toFileSize (size) {
    ...
    if (size < 1024.00)
      return hsz.toDecimal(size) + " 字节";
    else if (size >= 1024.00 && size < 1048576)
      return hsz.toDecimal(size / 1024.00) + " KB";
    else if (size >= 1048576 && size < 1073741824)
      return hsz.toDecimal(size / 1024.00 / 1024.00) + " MB";
    else if (size >= 1073741824)
      return hsz.toDecimal(size / 1024.00 / 1024.00 / 1024.00) + " GB";
  },
  toDecimal (num) {
    if (num == null) {
      num = "0";
