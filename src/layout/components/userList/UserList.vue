<template>
  <div>
    <el-drawer title="内部聊天"
               :visible.sync="drawer"
               direction="rtl"
               class="contacts-drawer HSZ-common-drawer"
               size="280px"
               :modal="true"
      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="消息"
                     name="reply">
          <div class="userList replyList"
               v-loading="replyLoading && listQuery.currentPage==1">
            <div v-if="replyList.length">
              <div v-for="(item,i) in replyList"
                   :key="i"
                   class="userList-item"
                ...
                <div class="userList-txt">
                  <p class="title">
                    ...
                    <el-badge :value="item.unreadMessage"
