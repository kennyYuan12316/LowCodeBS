        ...
        <div class="chatList"
          ...
          <div class="chatList-item"
            ...
            <div class="chatList-text">
              ...
              <p v-if="item.messageType=='text'"
                 v-html="item.message"
                 class="chatList__msg--text">
              </p>
              <el-image :src="define.comUrl+item.message.path"
                        class="chatList__msg--img"
                        v-if="item.messageType=='image' && item.message.path"
                        :preview-src-list="[define.comUrl+item.message.path]"
                        :z-index="10000">
              </el-image>
              <audio class="chatList__msg--audio"
                     controls
        ...
        <div class="toolBox">
          <div class="toolBox-left">
            <el-popover placement="top-start"
              ...
              <div class="emjioBox">
                <ul class="emjio">
                  <li v-for="(item,i) in this.emojiList"
                      :key="i"
              ...
              <el-link icon="sz-custom sz-custom-emoticon-neutral"
                       :underline="false"
                       title="发送表情"
                       slot="reference">
              </el-link>
            ...
            <el-upload :show-file-list="false"
                       ...
                       ref="upload"
                       accept="image/*">
              <el-link icon="sz-custom sz-custom-image"
                       :underline="false"
                       title="发送图片">
              </el-link>
            </el-upload>
          ...
          <div class="toolBox-right">
            <el-link icon="icon-sz icon-sz-generator-time"
                     :underline="false"
                     @click="openHistory">
              聊天记录
            </el-link>
        ...
        <div class="writeBox">
          ...
          <div class="btns">
            <el-button type="primary"
                       @click="sendMessage()">发 送</el-button>
          </div>
        </div>
      </div>
    ...
    getList (data) {
      ...
      for (let i = 0; i < data.list.length; i++) {
        ...
        list.push({
          ...
          dateTime: this.hsz.toDate(item.sendTime)
        })
      }
      if (!this.showHistory) {
        this.list = list
