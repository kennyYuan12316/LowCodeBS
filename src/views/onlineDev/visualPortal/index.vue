<template>
  <div class="HSZ-common-layout">
    ...
    <Transfer ref="transfer"
              ...
              :id="transferId" />
    <el-dialog title="新建门户"
               :visible.sync="dialogVisible"
               class="HSZ-dialog HSZ-dialog-add HSZ-dialog_center"
               lock-scroll
               width="600px">
      <div class="add-main">
        <div class="add-item add-item-sys"
             @click="addOrUpdateHandle(1)">
          <i class="add-icon icon-sz icon-sz-customUrl"></i>
          <div class="add-txt">
        ...
        <div class="add-item"
          ...
          <i class="add-icon icon-sz icon-sz-pageDesign"></i>
          <div class="add-txt">
