<template>
  <el-dialog :title="!dataForm.id ? '新建门户' : '编辑门户'"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item label="链接类型"
                    prop="linkType">
        <el-select v-model="dataForm.linkType"
                   placeholder="选择链接类型">
          <el-option label="页面"
                     :value="0" />
          <el-option label="外链"
      ...
      <el-form-item label="链接地址"
                    prop="customUrl">
        <el-input v-model="dataForm.customUrl"
                  placeholder="链接地址">
          <template slot="prepend"
                    v-if="dataForm.linkType===0">@/views/</template>
        </el-input>
      </el-form-item>
      <el-form-item label="门户排序"
                    prop="sortCode">
