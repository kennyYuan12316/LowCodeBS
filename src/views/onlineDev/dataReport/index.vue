              ...
              <tableOpts @edit="addOrUpdateHandle(scope.row.id)"
                ...
                <el-dropdown hide-on-click>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="handlePreview(scope.row.id, scope.row.fullName)">预览
                    </el-dropdown-item>
