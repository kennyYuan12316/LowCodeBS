  ...
  <el-dialog :visible.sync="visible"
    ...
    <div class="main"
      ...
      <el-row type="flex"
        ...
        <el-col :xs="12"
          ...
          <el-form :model="dataForm"
            ...
            <group-title content="数据来源"
                         class="mb-10" />
            <div class="mb-20">
              <el-alert title="默认打印的时候必须传业务主键@formId给SQL语句里面作为Where查询条件"
                        type="warning"
                        show-icon
            ...
            <el-form-item label="SQL语句"
              ...
              <el-button icon="el-icon-plus"
                         @click="addSql()">新增SQL</el-button>
              <el-row v-for="(item,i) in sqlTemplate"
                      :key="i"
                      class="mt-10">
                <el-col :span="20">
      ...
      <template v-if="activeStep==1">
        <print-templater ref="printTemplater"
                         :treeData="treeData"
