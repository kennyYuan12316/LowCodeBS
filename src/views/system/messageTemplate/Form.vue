    ...
    <div class="HSZ-preview-main flow-form-main">
      <div class="HSZ-common-page-header">
        <el-page-header @back="goBack"
                        :content="!dataForm.id ? '新建消息模板' : '编辑消息模板'" />
        <div class="options">
        ...
        <el-col :span="12"
          ...
          <el-form :model="dataForm"
            ...
            <el-form-item label="通知方式">
              <el-checkbox v-model="dataForm.isEmail"
                           :true-label="1"
                           :false-label="0">邮箱
              </el-checkbox>
              <el-checkbox v-model="dataForm.isWecom"
                           :true-label="1"
                           :false-label="0">企业微信
              </el-checkbox>
              <el-checkbox v-model="dataForm.isDingTalk"
                           :true-label="1"
                           :false-label="0">钉钉
              </el-checkbox>
              <el-checkbox v-model="dataForm.isSms"
                           :true-label="1"
                           :false-label="0">短信
              </el-checkbox>
            </el-form-item>
            ...
            <group-title content="内容配置"
                         class="mb-20" />
            <el-form-item label="短信模板"
                          prop="smsId"
                          v-if="dataForm.isSms">
              <sms-dialog v-model="dataForm.smsId"
                          :title="dataForm.smsTemplateName"
                          @change="onSmsChange" />
            </el-form-item>
            <el-form-item label="参数定义"
                          prop="templateJson">
              <el-button icon="el-icon-plus"
                         @click="showDialog()">添加参数</el-button>
              <div class="tag-list">
                <el-tag v-for="(tag,index) in templateJson"
                        :key="tag.field"
                        effect="plain"
                        :closable="tag.closable"
                        @close="onTagClose(index)"
                        @click="addContent(tag)">
      ...
      <el-dialog title="添加参数"
        ...
        <el-form :model="fieldForm"
          ...
          <el-form-item label="参数名称"
                        prop="field">
            <el-input v-model="fieldForm.field"
