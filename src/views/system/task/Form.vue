            ...
            <el-col :span="24">
              <el-form-item label="任务编码"
                ...
                <el-input v-model="dataForm.enCode"
                          placeholder="任务编码"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="Cron表达式"
                            prop="executeContent.cron">
                <el-input v-model="dataForm.executeContent.cron"
                          placeholder="Cron表达式"
                          readonly>
              ...
              <el-form-item label="任务类型"
                ...
                <el-radio-group v-model="dataForm.executeType"
                  ...
                  <el-radio label="3">本地任务
                    <el-tooltip content="获取在程序中事先写好的本地方法"
                                placement="top">
            ...
            <template v-if="dataForm.executeType=='1'||dataForm.executeType=='2'">
              <el-col :span="24">
                <el-form-item label="接口选择"
                              prop="executeContent.interfaceId">
                  <interface-dialog v-model="dataForm.executeContent.interfaceId"
                                    :title="dataForm.executeContent.interfaceName"
                                    :dataType="dataType"
                                    @change="onFuncChange" />
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="请求参数"
                              prop="executeContent.parameter">
                  <el-row v-for="(item,i) in dataForm.executeContent.parameter"
                          :key="i"
                          class="mb-10">
                    <el-col :span="11">
                      <span class="required-sign">{{item.required?'*':''}}</span>{{item.fieldName?item.field+'('+item.fieldName+')':item.field}}
                    </el-col>
                    <el-col :span="12"
                            :offset="1">
            ...
            <template v-if="dataForm.executeType=='3'">
              <el-col :span="24">
                <el-form-item label="方法选择"
                              prop="executeContent.localHostTaskId">
                  <el-select v-model="dataForm.executeContent.localHostTaskId"
                             placeholder="请选择"
      ...
      <el-dialog title="Cron表达式"
        ...
        <span slot="footer"
          ...
          <el-button type="warning"
                     @click="resetCrontab">重 置</el-button>
          <el-button type="primary"
                     @click="getCrontabValue">{{$t('common.confirmButton')}}
          </el-button>
        </span>
      </el-dialog>
    </div>
