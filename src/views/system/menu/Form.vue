<template>
  <el-dialog :title="!dataForm.id ? '新建菜单' : '编辑菜单'"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item v-if="dataForm.type == 2 || dataForm.type == 7"
                    label="地址"
                    prop="urlAddress">
        <el-input v-model="dataForm.urlAddress"
                  placeholder="填写地址">
          ...
          <el-select slot="append"
            ...
            <el-option label="_self"
                       value="_self" />
            <el-option label="_blank"
                       value="_blank" />
          </el-select>
        </el-input>
      </el-form-item>
      <el-form-item v-if="[3,4,5,6,8].indexOf(dataForm.type)>-1"
                    label="关联"
                    prop="propertyJson.moduleId">
        <HSZ-TreeSelect v-model="dataForm.propertyJson.moduleId"
                        :options="tempData"
                        placeholder="请选择"
                        lastLevel
