<template>
  <div class="HSZ-common-layout menu-list">
    <div class="HSZ-common-layout-center">
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        <el-tabs type="border-card"
                 ...
                 class="menu-tab">
          <el-tab-pane label="Web菜单"
                       name="Web"></el-tab-pane>
          <el-tab-pane label="App菜单"
                       name="App"></el-tab-pane>
          <div class="box">
            <div class="HSZ-common-head">
              <topOpts @add="addOrUpdateHandle()">
                <upload-btn url="/api/system/Menu/Action/Import"
                            @on-success="initData" />
              </topOpts>
              <div class="HSZ-common-head-right">
                <el-tooltip effect="dark"
                            content="展开"
                            placement="top">
                  <el-link v-show="!expands"
                           type="text"
                           icon="icon-sz icon-sz-btn-expand HSZ-common-head-icon"
                           :underline="false"
                           @click="toggleExpand()" />
                </el-tooltip>
                <el-tooltip effect="dark"
                  ...
                  <el-link v-show="expands"
                           type="text"
                           icon="icon-sz icon-sz-btn-collapse HSZ-common-head-icon"
                           :underline="false"
                           @click="toggleExpand()" />
                </el-tooltip>
                <el-tooltip effect="dark"
                    ...
                    <template v-if="scope.row.type && scope.row.type!=1">
                      <el-dropdown>
                        <span class="el-dropdown-link">
                          <el-button type="text"
                                     size="mini">{{$t('common.moreBtn')}}<i class="el-icon-arrow-down el-icon--right"></i>
                          </el-button>
                        </span>
    ...
    <ButtonAuthorizeListDrawer v-if="buttonAuthorizeListDrawer"
                               ref="buttonAuthorizeList" />
    <ColumnAuthorizeListDrawer v-if="columnAuthorizeListDrawer"
                               ref="ColumnAuthorizeList" />
    <FormAuthorizeListDrawer v-if="formAuthorizeListDrawer"
                             ref="FormAuthorizeList" />
    <DataAuthorizeListDrawer v-if="dataAuthorizeListDrawer"
