<template>
  <el-dialog :title="!dataForm.id ? '新建方案' : '编辑方案'"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item v-for="(item, index) in condition"
        ...
        <el-row :gutter="5">
          ...
          <el-col :span="24"
                  v-for="(subItem, i) in item.groups"
                  :key="index + i"
                  class="mb-10">
            <el-row :gutter="5">
              <el-col :span="7">
                <el-select v-model="subItem.id"
                           placeholder="选择字段"
                           clearable
              ...
              <el-col :span="7">
                <el-select v-model="subItem.op"
                           placeholder="选择符号"
                           clearable>
                  <el-option v-for="item in subItem.opOptions"
                             :key="item.value"
                             :label="item.label"
                             :value="item.value">
                  </el-option>
              ...
              <el-col :span="8">
                <el-input v-model="subItem.value"
                          placeholder="输入字段值"
