<template>
  <div>
    <el-drawer :title="dialogTitle"
      ...
      <div class="HSZ-flex-main">
        <el-tabs type="border-card"
                 ...
                 class="HSZ-flex-tabs">
          <el-tab-pane label="方案管理"
                       name="dataAuthorizeScheme">
            <div class="HSZ-common-head">
              ...
              <div class="HSZ-common-head-right">
                <el-tooltip effect="dark"
                            ...
                            placement="top">
                  <el-link icon="icon-sz icon-sz-Refresh
                  HSZ-common-head-icon"
                           :underline="false"
            ...
            <HSZ-table v-loading="listLoading"
              ...
              <el-table-column prop="fullName"
                               label="方案名称"
                               width="160" />
              <el-table-column prop="conditionText"
                               label="过滤条件" />
          ...
          <el-tab-pane label="字段管理"
            ...
            <HSZ-table v-loading="dataListLoading"
              ...
              <el-table-column prop="type"
                               label="字段类型"
                               width="70" />
              <el-table-column prop="conditionSymbol"
                               label="条件符号"
                               show-overflow-tooltip />
              <el-table-column label="条件内容"
                               width="120">
                <template slot-scope="scope">
                  ...
                  <span v-if="scope.row.conditionText === '@organizationAndSuborganization'">当前组织及子组织</span>
    ...
    <DataSchemeForm v-if="dataSchemeFormVisible"
                    ref="DataSchemeForm"
                    @refreshDataList="getAuthorizeSchemeList" />
    <DataAuthorizeForm v-if="dataAuthorizeFormVisible"
