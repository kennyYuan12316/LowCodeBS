<template>
  <el-dialog :title="!dataForm.id ? '新建字段' : '编辑字段'"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item label="条件符号"
        ...
        <el-select v-model="conditionSymbol"
                   multiple
                   placeholder="请选择">
          <el-option v-for="item in conditionSymbolOptions"
                     :key="item.value"
                     :label="item.label"
                     :value="item.value">
          </el-option>
      ...
      <el-form-item label="条件内容"
                    prop="conditionText">
        <el-select v-model="dataForm.conditionText"
                   placeholder="请选择"
                   clearable>
          <el-option v-for="item in conditionTextOptions"
                     :key="item.value"
                     :label="item.label"
                     :value="item.value">
          </el-option>
