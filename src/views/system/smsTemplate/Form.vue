    ...
    <div class="HSZ-preview-main flow-form-main">
      <div class="HSZ-common-page-header">
        <el-page-header @back="goBack"
                        :content="!dataForm.id ? '新建短信模板' : '编辑短信模板'" />
        <div class="options">
        ...
        <el-col :span="12"
          ...
          <el-form :model="dataForm"
            ...
            <el-form-item label="模板编号"
                          prop="templateId">
              <el-input v-model="dataForm.templateId"
                        placeholder="模板编号"></el-input>
            </el-form-item>
            <el-form-item label="签名内容"
                          prop="signContent">
              <el-input v-model="dataForm.signContent"
                        placeholder="签名内容"></el-input>
            </el-form-item>
            <el-form-item label="应用编号"
                          prop="appId"
                          v-if="dataForm.company===2">
              <el-input v-model="dataForm.appId"
                        placeholder="应用编号"></el-input>
            </el-form-item>
            <el-form-item label="模板验证">
              <el-button @click="showDialog()"
                         :loading="testLoading">测试</el-button>
            </el-form-item>
      ...
      <el-dialog title="测试"
        ...
        <el-form :model="testForm"
          ...
          <el-form-item label="接收号码"
                        prop="phoneNumbers">
            <el-input v-model="testForm.phoneNumbers"
                      placeholder="接收号码"></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer"
              class="dialog-footer">
          ...
          <el-button type="primary"
                     @click="test"
                     :loading="testBtnLoading">测试</el-button>
        </span>
      </el-dialog>
    </div>
  </transition>
