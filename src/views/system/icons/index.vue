<template>
  <div class="HSZ-common-layout icons-container">
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        <el-tabs type="border-card"
          ...
          <el-tab-pane label="szIcon 图标">
            <el-row>
              <el-col :span="6"
                      v-for="(item,i) of szIconsList"
                      :key="i"
                      @click.native="handleClipboard(generateYmIconCode(item),$event)"
                      class="icon-item">
