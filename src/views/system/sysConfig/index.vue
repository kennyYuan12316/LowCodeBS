<template>
  <div class="app-container HSZ-flex-main systemConfig">
    <el-form ref="baseForm"
      ...
      <el-tabs v-model="activeName"
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="系统图标">
                <div class="img-list">
                  <single-img v-model="baseForm.loginIcon"
                              tip="登录图标" />
                  <single-img v-model="baseForm.navigationIcon"
                              tip="导航图标" />
                  <single-img v-model="baseForm.logoIcon"
                              tip="LOGO图标" />
                  <single-img v-model="baseForm.appIcon"
                              tip="APP图标" />
                </div>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="系统名称"
                            prop="sysName">
                <el-input v-model="baseForm.sysName"
                          clearable
                          placeholder="系统名称" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="系统版本"
                            prop="sysVersion">
                <el-input v-model="baseForm.sysVersion"
                          maxlength="8"
                          clearable
                          placeholder="系统版本" />
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="公司名称"
                            prop="companyName">
                <el-input v-model="baseForm.companyName"
                          clearable
                          placeholder="公司名称" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="版权信息"
                            prop="copyright">
                <el-input v-model="baseForm.copyright"
                          clearable
                          placeholder="版权信息" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="公司简称"
                            prop="companyCode">
                <el-input v-model="baseForm.companyCode"
                          clearable
                          placeholder="公司简称" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="公司地址"
                            prop="companyAddress">
                <el-input v-model="baseForm.companyAddress"
                          clearable
                          placeholder="公司地址" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="公司法人"
                ...
                <el-input v-model="baseForm.companyContacts"
                          clearable
                          placeholder="公司法人" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="公司电话"
                ...
                <el-input v-model="baseForm.companyTelePhone"
                          clearable
                          placeholder="公司电话" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="公司邮箱"
                            prop="companyEmail">
                <el-input v-model="baseForm.companyEmail"
                          clearable
                          placeholder="公司邮箱" />
              </el-form-item>
            </el-col>
            <el-col>
              <el-form-item label="系统描述"
                            prop="sysDescription">
                <el-input v-model="baseForm.sysDescription"
                          type="textarea"
        ...
        <el-tab-pane label="安全设置"
                     name="second">
          <el-alert title="注意：系统登录安全、黑名单IP限制"
                    type="warning"
                    :closable="false"
                    show-icon />
          <el-row>
            <el-col :span="18">
              ...
              <el-form-item label="登录方式">
                <el-select v-model="baseForm.singleLogin"
                           placeholder="请选择">
                  <el-option label="单一登录"
                             value="1" />
                  <el-option label="同时登录"
                             value="2" />
                </el-select>
              </el-form-item>
              <el-form-item label="超时登出">
                <el-input-number v-model="baseForm.tokenTimeout"
                                 :min="1"
                                 :precision="0"
                                 :step="1"
              ...
              <el-form-item label="密码错误次数">
                <el-input-number v-model="baseForm.passwordErrorsNumber"
                                 :min="0"
                                 :precision="0"
                                 :step="1"
                ...
                <div v-if="baseForm.lockType===2">
                  ...
                  <el-input-number v-model="baseForm.lockTime"
                                   :min="1"
                                   :precision="0"
                                   :step="1"
                                   controls-position="right" /> 分钟
              ...
              <el-form-item label="登录验证码">
                <el-switch v-model="baseForm.enableVerificationCode"
                           :active-value="1"
                           :inactive-value="0" />
              </el-form-item>
              <el-form-item label="验证码位数"
                            v-if="baseForm.enableVerificationCode">
                <el-input-number v-model="baseForm.verificationCodeNumber"
                                 :min="3"
                                 :max="6"
                                 :precision="0"
                                 :step="1"
              ...
              <el-form-item label="上次登录">
                <el-switch v-model="baseForm.lastLoginTimeSwitch"
                           :active-value="1"
                           :inactive-value="0" />
              </el-form-item>
              <el-form-item v-if="baseForm.lastLoginTimeSwitch">
                <el-card class="box-card"
                  ...
                  <div slot="header">
                    <span>上次登录信息提示</span>
                    <i style="float: right; padding: 11px 0"
                       class="el-icon-close" />
                  </div>
                  <div class="item">
              ...
              <el-form-item label="开启验证">
                <el-switch v-model="baseForm.whitelistSwitch"
                           :active-value="1"
                           :inactive-value="0" />
              </el-form-item>
              <el-form-item label="允许访问IP"
                            v-if="baseForm.whitelistSwitch">
        ...
        <el-tab-pane label="第三方设置"
          ...
          <el-tabs tab-position="left"
            ...
            <el-tab-pane label="短信配置">
              <el-alert title="注意：请在短信厂家官网网站开通申请"
                        type="warning"
                        :closable="false"
                        show-icon />
              <el-row style="margin-top: 15px">
                <el-col :span="12">
                  <el-form-item label="短信厂家"
                                prop="smsCompany">
                  ...
                  <el-form-item label="用户编号"
                                prop="smsKeyId">
                    <el-input v-model="baseForm.smsKeyId"
                              clearable
                              placeholder="请输入用户编号" />
                  </el-form-item>
                  <el-form-item label="用户秘钥"
                                prop="smsKeySecret">
                    <el-input v-model="baseForm.smsKeySecret"
                              show-password
                              clearable
                              placeholder="请输入用户秘钥" />
                  </el-form-item>
                  <el-form-item label="访问域名"
                                prop="domain">
                    <el-input v-model="baseForm.domain"
                              clearable
                              placeholder="请输入访问域名" />
                  </el-form-item>
                  <el-form-item label="支持地域"
                                prop="region">
                    <el-input v-model="baseForm.region"
                              clearable
                              placeholder="请输入支持地域" />
                  </el-form-item>
                  <el-form-item label="版本号"
                                prop="version">
                    <el-input v-model="baseForm.version"
                              clearable
                              placeholder="请输入版本号" />
                  </el-form-item>
                  <el-form-item>
            ...
            <el-tab-pane label="电子邮箱">
              <el-alert title="注意：系统邮件设置成功后所有邮件会由此邮箱发出"
                        type="warning"
                        :closable="false"
                        show-icon />
              <el-row :gutter="20"
                ...
                <el-col :span="12">
                  <el-form-item label="POP3服务"
                                prop="emailPop3Host">
                    <el-input v-model="baseForm.emailPop3Host"
                              clearable
                              placeholder="POP3服务" />
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="SMTP服务"
                                prop="emailSmtpHost">
                    <el-input v-model="baseForm.emailSmtpHost"
                              clearable
                              placeholder="SMTP服务" />
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="POP3端口"
                                prop="emailPop3Port">
                    <el-input-number v-model="baseForm.emailPop3Port"
                ...
                <el-col :span="12">
                  <el-form-item label="SMTP端口"
                                prop="emailSmtpPort">
                    <el-input-number v-model="baseForm.emailSmtpPort"
                                     controls-position="right" />
                  </el-form-item>
                </el-col>
                <el-col :span="12"
                  ...
                  <el-form-item label="显示名称"
                    ...
                    <el-input v-model="baseForm.emailSenderName"
                              clearable
                              placeholder="显示名称" />
                  </el-form-item>
                </el-col>
                <el-col :span="12"
                  ...
                  <el-form-item label="邮箱账户"
                                prop="emailAccount">
                    <el-input v-model="baseForm.emailAccount"
                              clearable
                              placeholder="邮箱账户" />
                  </el-form-item>
                </el-col>
                <el-col :span="12"
                  ...
                  <el-form-item label="邮箱密码"
                                prop="emailPassword">
                    <el-input v-model="baseForm.emailPassword"
                              show-password
                              placeholder="邮箱密码">
                      <el-button slot="append"
                                 @click="checkEmailStatus"
                                 :loading="testLoading">测试连接
                      </el-button>
                    </el-input>
                  </el-form-item>
                </el-col>
                <el-col>
                  <el-form-item label="SSL登录"
                                prop="emailSsl">
                    <el-switch v-model="baseForm.emailSsl"
                               :active-value="1"
                               :inactive-value="0" />
                  </el-form-item>
                  <el-form-item>
              ...
              <el-row :gutter="20"
                ...
                <el-col :span="12"
                  ...
                  <el-form-item label="企业号Id"
                                prop="qyhCorpId">
                    <el-input v-model="baseForm.qyhCorpId"
                              clearable
                ...
                <el-col :span="12"
                  ...
                  <el-form-item label="应用凭证"
                                prop="qyhAgentId">
                    <el-input v-model="baseForm.qyhAgentId"
                              clearable
                ...
                <el-col :span="12"
                  ...
                  <el-form-item label="凭证密钥"
                                prop="qyhAgentSecret">
                    <el-input v-model="baseForm.qyhAgentSecret"
                              placeholder="请输入AppSecret">
                      <el-button slot="append"
                                 @click="checkQy(0)"
                                 :loading="testQyLoading">连接测试
                      </el-button>
                    </el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12"
                  ...
                  <el-form-item label="同步密钥"
                                prop="qyhCorpSecret">
                    <el-input v-model="baseForm.qyhCorpSecret"
                              placeholder="请输入CorpSecret">
                      <el-button slot="append"
                                 @click="checkQy(1)"
                                 :loading="testSyncLoading">同步测试
                      </el-button>
                    </el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col>
                  <el-form-item label="同步反馈">
                    <el-table :data="wxResults"
                              border>
                      <el-table-column prop="synType"
                                       label="同步类型" />
                      <el-table-column prop="recordTotal"
                                       label="总数" />
                      <el-table-column prop="synSuccessCount"
                                       label="同步成功数" />
                      <el-table-column prop="synFailCount"
                                       label="同步失败数" />
                      <el-table-column prop="unSynCount"
                                       label="未同步数" />
                      <el-table-column prop="synDate"
                                       label="同步时间"
            ...
            <el-tab-pane label="阿里钉钉">
              <el-row :gutter="20"
                ...
                <el-col :span="12"
                  ...
                  <el-form-item label="企业号Id"
                                prop="dingAgentId">
                    <el-input v-model="baseForm.dingAgentId"
                              clearable
                              placeholder="请输入AgentId" />
                  </el-form-item>
                </el-col>
                <el-col :span="12"
                  ...
                  <el-form-item label="应用凭证"
                                prop="dingSynAppKey">
                    <el-input v-model="baseForm.dingSynAppKey"
                              clearable
                ...
                <el-col :span="12"
                        ...
                        :pull="6">
                  <el-form-item label="凭证密钥"
                                prop="dingSynAppSecret">
                    <el-input v-model="baseForm.dingSynAppSecret"
                              placeholder="请输入AppSecret">
                      <el-button slot="append"
                                 @click="checkDing"
                                 :loading="testDingLoading">连接测试
                      </el-button>
                    </el-input>
                  </el-form-item>
                </el-col>
        ...
        <el-tab-pane label="超级管理员"
                     name="fourth">
          <el-alert title="注意：设为超级管理员后该用户拥有系统最高权限"
                    type="warning"
                    :closable="false"
                    show-icon />
          <el-row :gutter="20"
