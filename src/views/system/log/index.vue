<template>
  <div class="HSZ-common-layout systemLogs">
          ...
          <el-tab-pane label="请求日志"
            ...
            <HSZ-table v-loading="listLoading"
              ...
              <el-table-column prop="requestMethod"
                               ...
                               width="80"
                               align="center" />
              <el-table-column prop="requestDuration"
                               label="耗时(毫秒)"
                               width="80" />
            </HSZ-table>
          </el-tab-pane>
            ...
            <HSZ-table v-loading="listLoading"
              ...
              <el-table-column prop="json"
                ...
                <template slot-scope="scope">
                  <el-link @click="goDetail(scope.row.json,'操作记录')"
          ...
          <el-tab-pane label="异常日志"
            ...
            <HSZ-table v-loading="listLoading"
              ...
              <el-table-column prop="json"
                               ...
                               min-width="200">
                <template slot-scope="scope">
                  <el-link @click="goDetail(scope.row.json,'异常描述')"
                           style="font-size:12px">
                    <p class="line1">{{ scope.row.json }}</p>
                  </el-link>
                </template>
