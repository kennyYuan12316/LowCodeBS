  ...
  <el-dialog :title="eventType==='audit'?'审批通过':'审批拒绝'"
    ...
    <el-form label-width="130px"
      ...
      <el-form-item label="加签人员"
                    v-if="eventType==='audit'&&properties&&properties.hasFreeApprover">
        <user-select v-model="freeApproverUserId"
                     placeholder="请选择加签人员,不选即该节点审核结束" />
      </el-form-item>
      <el-form-item label="审批意见"
                    prop="handleOpinion">
        <el-input v-model="dataForm.handleOpinion"
      ...
      <el-form-item label="抄送人员"
                    prop="copyIds"
                    v-if="properties&&properties.isCustomCopy">
