<template>
  <transition name="el-zoom-in-center">
    <div class="HSZ-preview-main">
          ...
          <el-form @submit.native.prevent>
            ...
            <el-col :span="6">
              <el-form-item label="所属流程">
                <el-select v-model="listQuery.flowId"
                           placeholder="选择所属流程"
                           clearable
                           @change="onFlowChange">
            ...
            <el-col :span="6">
              <el-form-item label="所属节点">
                <el-select v-model="listQuery.nodeCode"
                           placeholder="选择所属节点"
                           clearable
            ...
            <template v-if="showAll">
              ...
              <el-col :span="6">
                <el-form-item label="所属分类">
                  <el-select v-model="listQuery.flowCategory"
                             placeholder="选择所属分类"
                             clearable>
              ...
              <el-col :span="6">
                <el-form-item label="发起人员">
                  <user-select v-model="listQuery.creatorUserId"
                               placeholder="选择发起人员" />
                </el-form-item>
              </el-col>
            </template>
        ...
        <div class="HSZ-common-head">
          <div>
            ...
            <el-button type="danger"
                       @click="handleBatch(1)"
                       :disabled="!listQuery.nodeCode">批量拒绝
            </el-button>
          </div>
        </div>
      ...
      <approve-dialog v-if="approveVisible"
                      ref="approveDialog"
