  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('outgoingTotle')">
          <el-form-item label="外出总计"
                        prop="outgoingTotle">
            <el-input v-model="dataForm.outgoingTotle"
                      placeholder="外出总计"
                      :disabled="judgeWrite('outgoingTotle')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('startTime')">
        ...
        <el-col :span="24"
                v-if="judgeShow('destination')">
          <el-form-item label="目的地"
                        prop="destination">
            <el-input v-model="dataForm.destination"
                      placeholder="目的地"
        ...
        <el-col :span="24"
                v-if="judgeShow('outgoingCause')">
          <el-form-item label="外出事由"
                        prop="outgoingCause">
            <el-input v-model="dataForm.outgoingCause"
                      placeholder="外出事由"
                      type="textarea"
                      :rows="3"
