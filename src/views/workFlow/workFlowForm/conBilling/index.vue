  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('drawer')">
          <el-form-item label="开票人"
                        prop="drawer">
            <el-input v-model="dataForm.drawer"
                      placeholder="开票人"
                      :disabled="judgeWrite('drawer')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('billDate')">
        ...
        <el-col :span="12"
                v-if="judgeShow('conName')">
          <el-form-item label="关联名称"
                        prop="conName">
            <el-input v-model="dataForm.conName"
                      placeholder="关联名称"
        ...
        <el-col :span="12"
          ...
          <el-form-item label="开户银行"
            ...
            <el-input v-model="dataForm.bank"
                      placeholder="开户银行"
                      :disabled="judgeWrite('bank')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('amount')">
          <el-form-item label="开户账号"
                        prop="amount">
            <el-input v-model="dataForm.amount"
                      placeholder="开户账号"
                      :disabled="judgeWrite('amount')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('billAmount')">
          <el-form-item label="开票金额"
                        prop="billAmount">
            <el-input v-model="dataForm.billAmount"
                      placeholder="开票金额"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('taxId')">
          <el-form-item label="税号"
                        prop="taxId">
            <el-input v-model="dataForm.taxId"
                      placeholder="税号"
                      :disabled="judgeWrite('taxId')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('invoiceId')">
          <el-form-item label="发票号"
                        prop="invoiceId">
            <el-input v-model="dataForm.invoiceId"
                      placeholder="发票号"
                      :disabled="judgeWrite('invoiceId')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('invoAddress')">
          <el-form-item label="发票地址"
                        prop="invoAddress">
            <el-input v-model="dataForm.invoAddress"
                      placeholder="发票地址"
                      :disabled="judgeWrite('invoAddress')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('payAmount')">
