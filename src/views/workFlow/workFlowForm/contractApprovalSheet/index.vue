      ...
      <el-row>
        <el-col :span="12"
          ...
          <el-form-item label="流程标题"
                        prop="flowTitle">
            <el-input v-model="dataForm.flowTitle"
                      placeholder="流程标题"
                      :disabled="judgeWrite('flowTitle')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('flowUrgent')">
          <el-form-item label="紧急程度"
                        prop="flowUrgent">
            <el-select v-model="dataForm.flowUrgent"
                       placeholder="选择紧急程度"
        ...
        <el-col :span="12"
                v-if="judgeShow('applyUser')">
          <el-form-item label="申请人员"
                        prop="applyUser">
            <el-input v-model="dataForm.applyUser"
                      placeholder="申请人员"
                      readonly
        ...
        <el-col :span="12"
                v-if="judgeShow('contractId')">
          <el-form-item label="编码支出"
                        prop="contractId">
            <el-input v-model="dataForm.contractId"
                      placeholder="编码支出"
                      :disabled="judgeWrite('contractId')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('contractNum')">
        ...
        <el-col :span="12"
                v-if="judgeShow('firstParty')">
          <el-form-item label="签署方(甲方)"
                        prop="firstParty">
            <el-input v-model="dataForm.firstParty"
                      placeholder="签署方(甲方)"
                      :disabled="judgeWrite('firstParty')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('secondParty')">
          <el-form-item label="乙方"
                        prop="secondParty">
            <el-input v-model="dataForm.secondParty"
                      placeholder="乙方"
                      :disabled="judgeWrite('secondParty')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('contractName')">
        ...
        <el-col :span="12"
                v-if="judgeShow('personCharge')">
          <el-form-item label="合作负责人"
                        prop="personCharge">
            <el-input v-model="dataForm.personCharge"
                      placeholder="合作负责人"
                      :disabled="judgeWrite('personCharge')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('leadDepartment')">
          <el-form-item label="所属部门"
                        prop="leadDepartment">
            <el-input v-model="dataForm.leadDepartment"
                      placeholder="所属部门"
                      :disabled="judgeWrite('leadDepartment')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('signArea')">
          <el-form-item label="签订地区"
                        prop="signArea">
            <el-input v-model="dataForm.signArea"
                      placeholder="签订地区"
                      :disabled="judgeWrite('signArea')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('incomeAmount')">
          <el-form-item label="收入金额"
                        prop="incomeAmount">
            <el-input v-model="dataForm.incomeAmount"
                      placeholder="收入金额"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('totalExpenditure')">
          <el-form-item label="支出总额"
                        prop="totalExpenditure">
            <el-input v-model="dataForm.totalExpenditure"
                      placeholder="支出总额"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('budgetaryApproval')">
          <el-form-item label="预算批付"
                        prop="budgetaryApproval">
            <el-input v-model="dataForm.budgetaryApproval"
                      placeholder="预算批付"
                      :disabled="judgeWrite('budgetaryApproval')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('startContractDate')">
          <el-form-item label="开始时间"
                        prop="startContractDate">
            <el-date-picker v-model="dataForm.startContractDate"
                            type="datetime"
                            placeholder="选择日期"
                            value-format="timestamp"
        ...
        <el-col :span="12"
                v-if="judgeShow('endContractDate')">
          <el-form-item label="结束时间"
                        prop="endContractDate">
            <el-date-picker v-model="dataForm.endContractDate"
                            type="datetime"
                            placeholder="选择日期"
                            value-format="timestamp"
                            format="yyyy-MM-dd HH:mm"
        ...
        <el-col :span="24"
                v-if="judgeShow('fileJson')">
          <el-form-item label="相关附件"
                        prop="fileJson">
            <HSZ-UploadFz v-model="fileList"
                          type="workFlow"
                          :disabled="judgeWrite('fileJson')" />
          </el-form-item>
        </el-col>
        <el-col :span="24"
                v-if="judgeShow('contractContent')">
          <el-form-item label="内容简要"
                        prop="contractContent">
            <el-input v-model="dataForm.contractContent"
                      placeholder="内容简要"
                      type="textarea"
                      :rows="3"
                      :disabled="judgeWrite('contractContent')" />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
