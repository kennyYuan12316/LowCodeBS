  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('drawPeople')">
          <el-form-item label="发件人"
                        prop="drawPeople">
            <el-input v-model="dataForm.drawPeople"
                      placeholder="发件人"
                      :disabled="judgeWrite('drawPeople')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('issuingDepartment')">
          <el-form-item label="发件部门"
                        prop="issuingDepartment">
            <el-input v-model="dataForm.issuingDepartment"
                      placeholder="发件部门"
                      :disabled="judgeWrite('issuingDepartment')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('toDate')">
          <el-form-item label="发件日期"
                        prop="toDate">
            <el-date-picker v-model="dataForm.toDate"
                            type="datetime"
                            placeholder="选择日期"
        ...
        <el-col :span="12"
                v-if="judgeShow('serviceDepartment')">
          <el-form-item label="收件部门"
                        prop="serviceDepartment">
            <el-input v-model="dataForm.serviceDepartment"
                      placeholder="收件部门"
                      :disabled="judgeWrite('serviceDepartment')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('recipients')">
          <el-form-item label="收件人"
                        prop="recipients">
            <el-input v-model="dataForm.recipients"
                      placeholder="收件人"
                      :disabled="judgeWrite('recipients')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('collectionDate')">
          <el-form-item label="收件日期"
                        prop="collectionDate">
            <el-date-picker v-model="dataForm.collectionDate"
                            type="datetime"
                            placeholder="选择日期"
                            value-format="timestamp"
                            format="yyyy-MM-dd HH:mm"
        ...
        <el-col :span="24"
                v-if="judgeShow('coordination')">
          <el-form-item label="协调事项"
                        prop="coordination">
            <el-input v-model="dataForm.coordination"
                      placeholder="协调事项"
                      type="textarea"
                      :rows="3"
