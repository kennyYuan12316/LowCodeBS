  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('outStorage')">
          <el-form-item label="出库人"
                        prop="outStorage">
            <el-input v-model="dataForm.outStorage"
                      placeholder="出库人"
                      :disabled="judgeWrite('outStorage')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('businessPeople')">
          <el-form-item label="业务人员"
                        prop="businessPeople">
            <el-input v-model="dataForm.businessPeople"
                      placeholder="业务人员"
                      :disabled="judgeWrite('businessPeople')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('businessType')">
        ...
        <el-col :span="12"
                v-if="judgeShow('outboundDate')">
          <el-form-item label="出库日期"
                        prop="outboundDate">
            <el-date-picker v-model="dataForm.outboundDate"
                            type="datetime"
                            placeholder="选择日期"
