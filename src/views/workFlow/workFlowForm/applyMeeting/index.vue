  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('conferenceName')">
          <el-form-item label="会议名称"
                        prop="conferenceName">
            <el-input v-model="dataForm.conferenceName"
                      placeholder="会议名称"
                      :disabled="judgeWrite('conferenceName')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('conferenceTheme')">
          <el-form-item label="会议主题"
                        prop="conferenceTheme">
            <el-input v-model="dataForm.conferenceTheme"
                      placeholder="会议主题"
                      :disabled="judgeWrite('conferenceTheme')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('conferenceType')">
          <el-form-item label="会议类型"
                        prop="conferenceType">
            <el-input v-model="dataForm.conferenceType"
                      placeholder="会议类型"
                      :disabled="judgeWrite('conferenceType')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('estimatePeople')">
          <el-form-item label="预计人数"
                        prop="estimatePeople">
            <el-input v-model="dataForm.estimatePeople"
                      placeholder="预计人数"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('conferenceRoom')">
          <el-form-item label="会议室"
                        prop="conferenceRoom">
            <el-input v-model="dataForm.conferenceRoom"
                      placeholder="会议室"
                      :disabled="judgeWrite('conferenceRoom')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('administrator')">
          <el-form-item label="管理人"
                        prop="administrator">
            <el-input v-model="dataForm.administrator"
                      placeholder="管理人"
                      :disabled="judgeWrite('administrator')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('lookPeople')">
          <el-form-item label="查看人"
                        prop="lookPeople">
            <el-input v-model="dataForm.lookPeople"
                      placeholder="查看人"
        ...
        <el-col :span="12"
                v-if="judgeShow('memo')">
          <el-form-item label="纪要员"
                        prop="memo">
            <el-input v-model="dataForm.memo"
                      placeholder="纪要员"
                      :disabled="judgeWrite('memo')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('attendees')">
          <el-form-item label="出席人"
                        prop="attendees">
            <el-input v-model="dataForm.attendees"
                      placeholder="出席人"
                      :disabled="judgeWrite('attendees')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('applyMaterial')">
          <el-form-item label="申请材料"
                        prop="applyMaterial">
            <el-input v-model="dataForm.applyMaterial"
                      placeholder="申请材料"
                      :disabled="judgeWrite('applyMaterial')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('estimatedAmount')">
          <el-form-item label="预计金额"
                        prop="estimatedAmount">
            <el-input v-model="dataForm.estimatedAmount"
                      placeholder="预计金额"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('otherAttendee')">
          <el-form-item label="其他出席人"
                        prop="otherAttendee">
            <el-input v-model="dataForm.otherAttendee"
                      placeholder="其他出席人"
