  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('warehousCategory')">
          <el-form-item label="入库类别"
                        prop="warehousCategory">
            <el-input v-model="dataForm.warehousCategory"
                      placeholder="入库类别"
        ...
        <el-col :span="12"
                v-if="judgeShow('warehousesPeople')">
          <el-form-item label="入库人"
                        prop="warehousesPeople">
            <el-input v-model="dataForm.warehousesPeople"
                      placeholder="入库人"
                      :disabled="judgeWrite('warehousesPeople')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('deliveryNo')">
          <el-form-item label="送货单号"
                        prop="deliveryNo">
            <el-input v-model="dataForm.deliveryNo"
                      placeholder="送货单号"
                      :disabled="judgeWrite('deliveryNo')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('warehouseNo')">
          <el-form-item label="入库单号"
                        prop="warehouseNo">
            <el-input v-model="dataForm.warehouseNo"
                      placeholder="入库单号"
                      :disabled="judgeWrite('warehouseNo')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('warehousDate')">
          <el-form-item label="入库日期"
                        prop="warehousDate">
            <el-date-picker v-model="dataForm.warehousDate"
                            type="datetime"
                            placeholder="选择日期"
