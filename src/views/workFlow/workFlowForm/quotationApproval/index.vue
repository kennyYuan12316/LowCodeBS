  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('writer')">
          <el-form-item label="填报人"
                        prop="writer">
            <el-input v-model="dataForm.writer"
                      placeholder="填报人"
                      :disabled="judgeWrite('writer')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('writeDate')">
          <el-form-item label="填报日期"
                        prop="writeDate">
            <el-date-picker v-model="dataForm.writeDate"
                            type="datetime"
                            placeholder="选择日期"
        ...
        <el-col :span="12"
                v-if="judgeShow('partnerName')">
          <el-form-item label="合作人名"
                        prop="partnerName">
            <el-input v-model="dataForm.partnerName"
                      placeholder="合作人名"
                      :disabled="judgeWrite('partnerName')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('standardFile')">
          <el-form-item label="模板参考"
                        prop="standardFile">
            <el-input v-model="dataForm.standardFile"
                      placeholder="模板参考"
                      :disabled="judgeWrite('standardFile')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24"
                v-if="judgeShow('quotationType')">
        ...
        <el-col :span="24"
                v-if="judgeShow('custSituation')">
          <el-form-item label="情况描述"
                        prop="custSituation">
            <el-input v-model="dataForm.custSituation"
                      placeholder="情况描述"
                      type="textarea"
                      :rows="3"
