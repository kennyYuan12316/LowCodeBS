  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="24"
                v-if="judgeShow('leaveReason')">
          <el-form-item label="请假原因"
                        prop="leaveReason">
            <el-input v-model="dataForm.leaveReason"
                      placeholder="请假原因"
                      type="textarea"
                      :rows="3"
        ...
        <el-col :span="12"
                v-if="judgeShow('leaveStartTime')">
          <el-form-item label="起始时间"
                        prop="leaveStartTime">
            <el-date-picker v-model="dataForm.leaveStartTime"
                            type="datetime"
                            placeholder="选择日期"
                            value-format="timestamp"
        ...
        <el-col :span="12"
                v-if="judgeShow('leaveEndTime')">
          <el-form-item label="结束时间"
                        prop="leaveEndTime">
            <el-date-picker v-model="dataForm.leaveEndTime"
                            type="datetime"
                            placeholder="选择日期"
                            value-format="timestamp"
                            format="yyyy-MM-dd HH:mm"
        ...
        <el-col :span="12"
                v-if="judgeShow('leaveDayCount')">
          <el-form-item label="请假天数"
                        prop="leaveDayCount">
            <el-input v-model="dataForm.leaveDayCount"
                      placeholder="请假天数"
        ...
        <el-col :span="12"
                v-if="judgeShow('leaveHour')">
          <el-form-item label="请假小时"
                        prop="leaveHour">
            <el-input v-model="dataForm.leaveHour"
                      placeholder="请假小时"
