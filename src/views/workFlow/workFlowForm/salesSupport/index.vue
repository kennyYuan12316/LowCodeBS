  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('applyDept')">
          <el-form-item label="申请部门"
                        prop="applyDept">
            <el-input v-model="dataForm.applyDept"
                      placeholder="申请部门"
                      readonly
        ...
        <el-col :span="12"
                v-if="judgeShow('psaleSupInfo')">
          <el-form-item label="售前支持"
                        prop="psaleSupInfo">
            <el-input v-model="dataForm.psaleSupInfo"
                      placeholder="售前支持"
        ...
        <el-col :span="12"
                v-if="judgeShow('psaleSupDays')">
          <el-form-item label="支持天数"
                        prop="psaleSupDays">
            <el-input v-model="dataForm.psaleSupDays"
                      placeholder="支持天数"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('psalePreDays')">
          <el-form-item label="准备天数"
                        prop="psalePreDays">
            <el-input v-model="dataForm.psalePreDays"
                      placeholder="准备天数"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('consulManager')">
          <el-form-item label="机构咨询"
                        prop="consulManager">
            <el-input v-model="dataForm.consulManager"
                      placeholder="机构咨询"
                      :disabled="judgeWrite('consulManager')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('psalSupConsul')">
          <el-form-item label="售前顾问"
                        prop="psalSupConsul">
            <el-input v-model="dataForm.psalSupConsul"
                      placeholder="售前顾问"
        ...
        <el-col :span="24"
                v-if="judgeShow('salSupConclu')">
          <el-form-item label="销售总结"
                        prop="salSupConclu">
            <el-input v-model="dataForm.salSupConclu"
                      placeholder="销售总结"
                      type="textarea"
                      :rows="3"
        ...
        <el-col :span="24"
                v-if="judgeShow('consultResult')">
          <el-form-item label="交付说明"
                        prop="consultResult">
            <el-input v-model="dataForm.consultResult"
                      placeholder="交付说明"
                      type="textarea"
                      :rows="3"
        ...
        <el-col :span="24"
                v-if="judgeShow('ievaluation')">
          <el-form-item label="咨询评价"
                        prop="ievaluation">
            <el-input v-model="dataForm.ievaluation"
                      placeholder="咨询评价"
                      type="textarea"
                      :rows="3"
        ...
        <el-col :span="24"
                v-if="judgeShow('conclusion')">
          <el-form-item label="发起人总结"
                        prop="conclusion">
            <el-input v-model="dataForm.conclusion"
                      placeholder="发起人总结"
                      type="textarea"
                      :rows="3"
