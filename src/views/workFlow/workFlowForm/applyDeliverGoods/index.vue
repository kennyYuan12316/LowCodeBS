  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('customerAddres')">
          <el-form-item label="客户地址"
                        prop="customerAddres">
            <el-input v-model="dataForm.customerAddres"
                      placeholder="客户地址"
                      :disabled="judgeWrite('customerAddres')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('goodsBelonged')">
          <el-form-item label="货品所属"
                        prop="goodsBelonged">
            <el-input v-model="dataForm.goodsBelonged"
                      placeholder="货品所属"
                      :disabled="judgeWrite('goodsBelonged')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('invoiceDate')">
          <el-form-item label="发货日期"
                        prop="invoiceDate">
            <el-date-picker v-model="dataForm.invoiceDate"
                            type="datetime"
                            placeholder="选择日期"
        ...
        <el-col :span="12"
                v-if="judgeShow('freightCompany')">
          <el-form-item label="货运公司"
                        prop="freightCompany">
            <el-input v-model="dataForm.freightCompany"
                      placeholder="货运公司"
                      :disabled="judgeWrite('freightCompany')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('deliveryType')">
          <el-form-item label="发货类型"
                        prop="deliveryType">
            <el-input v-model="dataForm.deliveryType"
                      placeholder="发货类型"
                      :disabled="judgeWrite('deliveryType')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('rransportNum')">
          <el-form-item label="货运单号"
                        prop="rransportNum">
            <el-input v-model="dataForm.rransportNum"
                      placeholder="货运单号"
                      :disabled="judgeWrite('rransportNum')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('freightCharges')">
          <el-form-item label="货运费用"
                        prop="freightCharges">
            <el-input v-model="dataForm.freightCharges"
                      placeholder="货运费用"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('cargoInsurance')">
          <el-form-item label="保险金额"
                        prop="cargoInsurance">
            <el-input v-model="dataForm.cargoInsurance"
                      placeholder="保险金额"
                      type="number"
        ...
        <el-col :span="12"
                v-if="judgeShow('invoiceValue')">
          <el-form-item label="发货金额"
                        prop="invoiceValue">
            <el-input v-model="dataForm.invoiceValue"
                      placeholder="发货金额"
                      type="number"
    ...
    <template v-if="judgeShow('entryList')">
      ...
      <el-table :data="dataForm.entryList"
                size='mini'>
      ...
      <div class="table-actions"
        ...
        <el-button type="text"
                   icon="el-icon-plus"
                   :disabled="setting.readonly">新增</el-button>
      </div>
    </template>
  </div>
</template>
