  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('departmental')">
          <el-form-item label="申请部门"
                        prop="departmental">
            <el-input v-model="dataForm.departmental"
                      placeholder="申请部门"
                      :disabled="judgeWrite('departmental')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('vendorName')">
          <el-form-item label="供应商名称"
                        prop="vendorName">
            <el-input v-model="dataForm.vendorName"
                      placeholder="供应商名称"
                      :disabled="judgeWrite('vendorName')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('buyer')">
          <el-form-item label="采购人员"
                        prop="buyer">
            <el-input v-model="dataForm.buyer"
                      placeholder="采购人员"
                      :disabled="judgeWrite('buyer')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('purchaseDate')">
        ...
        <el-col :span="12"
                v-if="judgeShow('warehouse')">
          <el-form-item label="仓库"
                        prop="warehouse">
            <el-input v-model="dataForm.warehouse"
                      placeholder="仓库"
                      :disabled="judgeWrite('warehouse')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('telephone')">
        ...
        <el-col :span="12"
                v-if="judgeShow('paymentMoney')">
          <el-form-item label="支付总额"
                        prop="paymentMoney">
            <el-input v-model="dataForm.paymentMoney"
                      placeholder="支付总额"
                      type="number"
        ...
        <el-col :span="24"
                v-if="judgeShow('reason')">
          <el-form-item label="用途原因"
                        prop="reason">
