  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('salesDate')">
          <el-form-item label="开单日期"
                        prop="salesDate">
            <el-date-picker v-model="dataForm.salesDate"
                            type="datetime"
                            placeholder="选择日期"
        ...
        <el-col :span="12"
                v-if="judgeShow('salesman')">
          <el-form-item label="业务人员"
                        prop="salesman">
            <el-input v-model="dataForm.salesman"
                      placeholder="业务人员"
                      :disabled="judgeWrite('salesman')"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12"
                v-if="judgeShow('ticketNum')">
          <el-form-item label="发票编码"
                        prop="ticketNum">
            <el-input v-model="dataForm.ticketNum"
                      placeholder="发票编码"
        ...
        <el-col :span="24"
                v-if="judgeShow('flowTfileJsonitle')">
