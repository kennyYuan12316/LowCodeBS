  ...
  <div class="flow-form"
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        ...
        <el-col :span="12"
                v-if="judgeShow('issuedNum')">
          <el-form-item label="发文字号"
                        prop="issuedNum">
            <el-input v-model="dataForm.issuedNum"
                      placeholder="发文字号"
        ...
        <el-col :span="12"
                v-if="judgeShow('mainDelivery')">
          <el-form-item label="主送"
                        prop="mainDelivery">
            <el-input v-model="dataForm.mainDelivery"
                      placeholder="主送"
        ...
        <el-col :span="12"
          ...
          <el-form-item label="抄送"
                        prop="copy">
            <el-input v-model="dataForm.copy"
                      placeholder="抄送"
                      :disabled="judgeWrite('copy')">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24"
