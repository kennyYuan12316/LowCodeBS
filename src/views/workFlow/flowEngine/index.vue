  ...
  <div class="HSZ-common-layout">
    <div class="HSZ-common-layout-center">
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading"
          ...
          <el-table-column prop="visibleType"
                           label="可见范围"
                           width="80">
            <template slot-scope="scope">
    ...
    <el-dialog title="新建表单"
      ...
      <div class="add-main">
        ...
        <div class="add-item"
             @click="addFlow(2)">
          <i class="add-icon icon-sz icon-sz-generator-company"></i>
          <div class="add-txt">
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               class="HSZ-dialog HSZ-dialog_center code-dialog"
               title="预览"
               width="400px"
               @opened="getQRimg">
