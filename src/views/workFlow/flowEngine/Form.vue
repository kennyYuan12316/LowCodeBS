          ...
          <el-form :model="dataForm"
            ...
            <el-form-item label="流程类型"
              ...
              <el-select v-model="dataForm.type"
                ...
                <el-option label="发起流程"
                           :value="0" />
                <el-option label="功能流程"
                           :value="1" />
              </el-select>
            </el-form-item>
                  ...
                  <div style="flex:1;margin-right:10px">
                    <el-input v-model="dataForm.icon"
                      ...
                      <el-button slot="append"
                                 @click="openIconBox()">选择</el-button>
                    </el-input>
                  </div>
                  <el-color-picker v-model="dataForm.iconBackground"
                                   title="图标背景色"
            ...
            <template v-if="dataForm.formType == 1">
              <el-form-item label="Web地址"
                            prop="formUrl">
                <el-input v-model="dataForm.formUrl"
                          placeholder="Web地址">
            ...
            <template v-if="dataForm.formType == 2">
              ...
              <el-table :data="tables"
                ...
                <el-table-column prop="tableField"
                                 label="外键字段">
                  <template slot-scope="scope"
                            v-if="scope.row.typeId !=='1'">
                    <el-select v-model="scope.row.tableField"
                               placeholder="请选择">
                ...
                <el-table-column prop="relationField"
                                 label="关联主键">
                  <template slot-scope="scope"
                            v-if="scope.row.typeId !=='1'">
                    <el-select v-model="scope.row.relationField"
                               placeholder="请选择">
                      <el-option v-for="item in mainTableFields"
                                 :key="item.field"
                                 :label="item.field"
                                 :value="item.field">
                      </el-option>
              ...
              <div class="table-actions"
                   @click="openTableBox">
                <el-button type="text"
                           icon="el-icon-plus">新增一行</el-button>
              </div>
            </template>
          </el-form>
        </el-col>
