		...
		<div class="HSZ-common-layout-center">
			<el-row class="HSZ-common-search-box" :gutter="16">
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="5555">
							<el-input v-model="query.t1" placeholder="5555" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="t1" label="5555" align="left" />
					<el-table-column prop="t2" label="56555" align="left" />
	...
	export default {
		...
		methods: {
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltT/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
