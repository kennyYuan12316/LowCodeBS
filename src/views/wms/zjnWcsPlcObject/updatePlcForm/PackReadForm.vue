    ...
    <el-dialog :title="'编辑PLC   DB'+this.item.db+'-'+this.item.objType" append-to-body :close-on-click-modal="false" :visible.sync="visible"
        ...
        <el-row :gutter="15" class="">
            <el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right"
                ...
                <el-col :span="12">
                    <el-form-item label="目标位置" prop="TargetPosition_S">
                        <el-input v-model='dataForm.TargetPosition_S' placeholder='请输入' clearable
                            :style='{ "width": "100%" }'>
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="产品类型" prop="ProductPlc">
                        <el-input-number v-model='dataForm.ProductPlc' placeholder='数字文本' :step='1'
                            controls-position='right'>
                        </el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="握手类型" prop="RequestPlc">
                        <el-input-number v-model='dataForm.RequestPlc' placeholder='数字文本' :step='1'
                            controls-position='right'>
                        </el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="Agv交互" prop="AgvPlc">
                        <el-input-number v-model='dataForm.AgvPlc' placeholder='数字文本' :step='1'
                            controls-position='right'>
                        </el-input-number>
                    </el-form-item>
                </el-col>
