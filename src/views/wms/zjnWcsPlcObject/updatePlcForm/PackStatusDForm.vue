    ...
    <el-dialog :title="'编辑PLC   DB'+this.item.db+'-'+this.item.objType" append-to-body :close-on-click-modal="false" :visible.sync="visible"
        ...
        <el-row :gutter="15" class="">
            <el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right"
                ...
                <el-col :span="12">
                    <el-form-item label="目标位置1" prop="TargetPosition1_S">
                        <el-input v-model='dataForm.TargetPosition1_S' placeholder='请输入' clearable
                            :style='{ "width": "100%" }'>
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="目标位置2" prop="TargetPosition2_S">
                        <el-input v-model='dataForm.TargetPosition2_S' placeholder='请输入' clearable
                            :style='{ "width": "100%" }'>
                        </el-input>
                    </el-form-item>
                </el-col>
