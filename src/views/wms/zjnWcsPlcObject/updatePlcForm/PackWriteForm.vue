    ...
    <el-dialog :title="'编辑PLC   DB'+this.item.db+'-'+this.item.objType" append-to-body :close-on-click-modal="false" :visible.sync="visible"
        ...
        <el-row :gutter="15" class="">
            <el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right"
                ...
                <el-col :span="12">
                    <el-form-item label="产品类型" prop="ProductWcs">
                        <el-input-number v-model='dataForm.ProductWcs' placeholder='数字文本' :step='1'
                            controls-position='right'>
                        </el-input-number>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item label="Agv交互" prop="AgvWcs">
                        <el-input-number v-model='dataForm.AgvWcs' placeholder='数字文本' :step='1'
                            controls-position='right'>
                        </el-input-number>
                    </el-form-item>
                </el-col>
