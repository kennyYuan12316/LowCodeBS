  ...
  <el-dialog :title="!dataForm.id ? '新建' :  isDetail ? '详情':'编辑'" :close-on-click-modal="false" :visible.sync="visible"
    ...
    <el-row :gutter="15" class="">
      <el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right"
        ...
        <el-col :span="12">
          <el-form-item label="Plc点位" prop="plcPointId">
            <popupSelect v-model='dataForm.plcPointId' field='plcPointId' placeholder='请选择' clearable
              relationField='Caption' :columnOptions='plcPointIdOptions' :pageSize='20' propsValue='PlcPointID'
              interfaceId='348280351916819717' popupType='dialog' popupTitle='选择数据' popupWidth='800px'>
            </popupSelect>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="Plc设备" prop="plcId">
            <popupSelect v-model='dataForm.plcId' field='plcId' placeholder='请选择' clearable relationField='PlcID'
              :columnOptions='plcIdOptions' :pageSize='20' propsValue='PlcID' interfaceId='348275272966997253'
        ...
        <el-col :span="24">
          <el-form-item label="对象json" prop="objValue">
            <el-input v-model='dataForm.objValue' placeholder='请输入' clearable :style='{"width":"100%"}'>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="读写类型" prop="packType">
            <el-select v-model='dataForm.packType' placeholder='请选择' clearable :style='{"width":"100%"}'>
              <el-option v-for="(item, index) in packTypeOptions" :key="index" :label="item.fullName" :value="item.id">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="Plc包大小" prop="packSize">
        ...
        <el-col :span="12">
          <el-form-item label="设备ID" prop="deviceId">
            <popupSelect v-model='dataForm.deviceId' field='deviceId' placeholder='请选择' clearable
              relationField='fullName' :columnOptions='deviceIdOptions' :pageSize='20' propsValue='id'
              interfaceId='343201383203210501' popupType='dialog' popupTitle='选择数据' popupWidth='800px'>
            </popupSelect>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="设备分组" prop="stackerGroup">
            <el-input v-model='dataForm.stackerGroup' placeholder='请输入' clearable :style='{"width":"100%"}'>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
