				...
				<el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right" :disabled="!!isDetail" :rules="rules">
					<el-col :span="24">
						<el-form-item label-width="0">
							<groupTitle content-position="left" content="info"></groupTitle>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="age" prop="age">
							<el-input v-model='dataForm.age' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
				</el-form>
		...
		methods: {
			...
			init(id, isDetail) {
				...
				this.$nextTick(() => {
					...
					if (this.dataForm.id) {
						request({
							url: '/api/wms/Test01/' + this.dataForm.id,
							method: 'get'
						}).then(res =>{
