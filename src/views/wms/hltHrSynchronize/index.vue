		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="系统名称">
							<el-input v-model="query.n4" placeholder="系统名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="映射名称">
							<el-input v-model="query.n6" placeholder="映射名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="任务标识">
							<el-input v-model="query.n2" placeholder="任务标识" clearable />	
						</el-form-item>
					</el-col>
					<template v-if="showAll">
					<el-col :span="6">
						<el-form-item label="错误标识">
							<el-input v-model="query.n8" placeholder="错误标识" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="创建时间">
							<el-date-picker v-model="query.n10" type="datetimerange" value-format="timestamp" format="yyyy-MM-dd HH:mm:ss" start-placeholder="开始日期" end-placeholder="结束日期">
							</el-date-picker>
						</el-form-item>
					</el-col>
					</template>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="n1" label="日志标识" align="left" />
					<el-table-column prop="n2" label="任务标识" align="left" />
					<el-table-column prop="n3" label="系统编码" align="left" />
					<el-table-column prop="n4" label="系统名称" align="left" />
					<el-table-column prop="n5" label="映射编码" align="left" />
					<el-table-column prop="n6" label="映射名称" align="left" />
					<el-table-column prop="n7" label="同步数量" align="left" />
					<el-table-column prop="n8" label="错误标识" align="left" />
					<el-table-column prop="n9" label="耗时" align="left" />
					<el-table-column prop="n10" label="创建时间" align="left" />
		...
		methods: {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrSynchronize/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrSynchronize/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrSynchronize/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
