		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="类型名称">
							<el-input v-model="query.t2" placeholder="类型名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					...
					<el-table-column prop="t2" label="类型名称" align="left" />
					<el-table-column prop="t3" label="类型编码" align="left" />
					<el-table-column prop="t4" label="类型序列" align="left" />
		...
		methods: {
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrT1/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrT1/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
