		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="任务名称">
							<el-input v-model="query.i2" placeholder="任务名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="映射名称">
							<el-input v-model="query.i3" placeholder="映射名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="系统名称">
							<el-input v-model="query.i4" placeholder="系统名称" clearable />	
						</el-form-item>
					</el-col>
					<template v-if="showAll">
					<el-col :span="6">
						<el-form-item label="任务状态">
							<el-input v-model="query.i6" placeholder="任务状态" clearable />	
						</el-form-item>
					</el-col>
					</template>
					<el-col :span="6">
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="i1" label="编号" align="left" />
					<el-table-column prop="i2" label="任务名称" align="left" />
					<el-table-column prop="i3" label="映射名称" align="left" />
					<el-table-column prop="i4" label="系统名称" align="left" />
					<el-table-column prop="i5" label="任务时间表达式" align="left" />
					<el-table-column prop="i6" label="任务状态" align="left" />
		...
		methods: {
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrRegular/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrRegular/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
