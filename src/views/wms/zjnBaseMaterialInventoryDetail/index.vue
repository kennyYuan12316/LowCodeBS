				...
				<el-form @submit.native.prevent>
					...
					<el-col :span="6">
						<el-form-item label="是否冻结">
							<el-input v-model="query.F_Freeze" placeholder="是否冻结" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
		...
		methods: {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnBaseMaterialInventoryDetail/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnBaseMaterialInventoryDetail/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnBaseMaterialInventoryDetail/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
