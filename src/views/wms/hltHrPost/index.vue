		...
		<div class="HSZ-common-layout-center">
			<el-row class="HSZ-common-search-box" :gutter="16">
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="岗位模板名称">
							<el-input v-model="query.c2" placeholder="岗位模板名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list">
					<el-table-column prop="c1" label="编号" align="left" />
					<el-table-column prop="c2" label="岗位模板名称" align="left" />
					<el-table-column prop="c3" label="岗位模板编码" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    { prop: 'c1', label: '编号' },
                    { prop: 'c2', label: '岗位模板名称' },
                    { prop: 'c3', label: '岗位模板编码' },
				],
			}
        },
		computed: {},
		...
		methods: {
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrPost/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
