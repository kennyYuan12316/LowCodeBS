    ...
    <div class="HSZ-common-layout-center">
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading" :data="list">
          ...
          <el-table-column label="单据类型" prop="F_OrderType" align="left" width="120" >
          ...
          <el-table-column label="物料类型" prop="F_ProductsType" align="left" width="120">
            <template
              slot-scope="scope">{{ scope.row.F_ProductsType | dynamicTextByenCode(productstypeOptions) }}</template>
          </el-table-column>
          ...
          <el-table-column label="校验状态" prop="F_InspectionStatus" align="left" width="120">
            <template
              slot-scope="scope">{{ scope.row.F_InspectionStatus | dynamicTextByenCode(InspectionStatusOptions) }}</template>
          </el-table-column>
          <el-table-column prop="F_ProductsBach" label="物料批次" align="left" width="250"/>
          <el-table-column prop="F_TheTray" label="托盘号" align="left" width="250"/>
          <el-table-column prop="F_TheContainer" label="容器号" align="left" width="250"/>
          <el-table-column prop="F_ExpiryDate" label="失效日期" align="left" width="150" >
            <template slot-scope="scope">
              {{ scope.row.F_ExpiryDate | toDate("yyyy-MM-dd hh:mm:ss") }}
            </template>
          </el-table-column>
          <el-table-column prop="F_ProductsUser" label="客户" align="left" width="250" />
          <el-table-column prop="F_ProductsSupplier" label="供应商" align="left" width="250" />
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        console.log(query);
        request({
          url: `/api/wms/ZjnBillsHistory/GetListChuk`,
          method: 'GET',
          data: query
        }).then(res => {
