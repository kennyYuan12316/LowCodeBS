    ...
    <div class="HSZ-common-layout-center">
        ...
        <el-form @submit.native.prevent>
          <el-col :span="6">
            <el-form-item label="客户名称">
              <el-input v-model="query.F_CustomerName" placeholder="客户名称" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="客户编号">
              <el-input v-model="query.F_CustomerNo" placeholder="客户编号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="联系人姓名">
              <el-input v-model="query.F_ContactName" placeholder="联系人姓名" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item>
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
          <el-table-column prop="F_CustomerNo" label="客户编号" align="left" />
          <el-table-column prop="F_CustomerName" label="客户名称" align="left" />
          <el-table-column prop="F_CustomerAddress" label="联系地址" align="left" />
          <el-table-column prop="F_CustomerPhone" label="联系方式" align="left" />
          <el-table-column prop="F_ContactName" label="联系人姓名" align="left" />
          ...
          <el-table-column label="有效标志" prop="F_EnabledMark" align="left">
            <template slot-scope="scope">
              <el-tag :type="scope.row.F_EnabledMark == '1' ? 'success' : 'danger'" disable-transitions>
                {{ scope.row.F_EnabledMark | dynamicText(enabledMarkOptions) }}
              </el-tag>
            </template>
          </el-table-column>
    ...
    data() {
      return {
        ...
        columnList: [{
          ...
          {
            prop: 'F_CustomerAddress',
            label: '联系地址'
          },
          {
            prop: 'F_CustomerPhone',
            label: '联系方式'
          },
          {
            prop: 'F_ContactName',
    ...
    methods: {
      ...
      handleDel(id) {
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          request({
            url: `/api/wms/ZjnBaseCustomer/${id}`,
            method: 'DELETE'
          }).then(res => {
            this.$message({
              type: 'success',
      ...
      handleBatchRemoveDel() {
        ...
        this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
          ...
          request({
            url: `/api/wms/ZjnBaseCustomer/batchRemove`,
            method: 'POST',
            data: ids,
          }).then(res => {
            this.$message({
