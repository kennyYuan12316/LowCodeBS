    ...
    <div class="HSZ-common-layout-center">
        ...
        <el-form @submit.native.prevent>
          <el-col :span="6">
            <el-form-item label="区域编号">
              <el-input v-model="query.F_RegionNo" placeholder="区域编号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="区域名称">
              <el-input v-model="query.F_RegionName" placeholder="区域名称" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6">
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
          <el-table-column prop="F_RegionNo" label="区域编号" align="left" />
          <el-table-column prop="F_RegionName" label="区域名称" align="left" />
    ...
    methods: {
      ...
      handleBatchRemoveDel() {
        ...
        this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
          ...
          request({
            url: `/api/wms/ZjnWmsRegion/batchRemove`,
            method: 'POST',
            data: ids,
          }).then(res => {
            this.$message({
