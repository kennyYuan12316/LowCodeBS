	...
	<el-dialog :title="!dataForm.id ? '新建' :  isDetail ? '详情':'编辑'" :close-on-click-modal="false" :visible.sync="visible" class="HSZ-dialog HSZ-dialog_center" lock-scroll width="600px">
		<el-row :gutter="15" class="" >
				<el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right" :disabled="!!isDetail" :rules="rules">
					<el-col :span="12">
						<el-form-item label="PLC连接" prop="plcConnectionId">
							<el-select v-model='dataForm.plcConnectionId' placeholder='请选择' clearable :style='{"width":"100%"}' >
								<el-option v-for="(item, index) in plcConnectionIdOptions" :key="index" :label="item.F_IP" :value="item.F_Id" ></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="偏移量" prop="offset">
							<el-input v-model='dataForm.offset' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="对像" prop="objectType">
							<el-input v-model='dataForm.objectType' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="请求服务" prop="requestServices">
							<el-input v-model='dataForm.requestServices' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
		...
		methods: {
			...
			init(id, isDetail) {
				...
				this.$nextTick(() => {
					...
					if (this.dataForm.id) {
						request({
							url: '/api/wms/ZjnPlcReadRequest/' + this.dataForm.id,
							method: 'get'
						}).then(res =>{
