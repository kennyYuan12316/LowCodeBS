		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					...
					<el-col :span="6">
						<el-form-item label="质量状态">
							<el-input v-model="query.F_Quality" placeholder="质量状态" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="订单">
							<el-input v-model="query.F_Order" placeholder="订单" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					...
					<el-table-column prop="F_Order" label="订单" align="left" />
					...
					<el-table-column prop="F_Operation" label="操作" align="left" />
	...
	export default {
		...
		methods: {
			initData() {
                ...
                request({
                    url: `/api/wms/ZjnRecordMaterialInventory`,
                    method: 'GET',
                    data: query
                }).then(res => {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnRecordMaterialInventory/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnRecordMaterialInventory/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnRecordMaterialInventory/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
