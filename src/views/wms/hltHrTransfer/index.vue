		...
		<div class="HSZ-common-layout-center">
			<el-row class="HSZ-common-search-box" :gutter="16">
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="来源系统名称">
							<el-input v-model="query.l3" placeholder="来源系统名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="信息类型名称">
							<el-input v-model="query.l5" placeholder="信息类型名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="任务标识">
							<el-input v-model="query.l2" placeholder="任务标识" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="l1" label="实时信息标识" align="left" />
					<el-table-column prop="l2" label="任务标识" align="left" />
					<el-table-column prop="l3" label="来源系统名称" align="left" />
					<el-table-column prop="l4" label="信息类型编码" align="left" />
					<el-table-column prop="l5" label="信息类型名称" align="left" />
					<el-table-column prop="l6" label="信息总数量" align="left" />
					<el-table-column prop="l7" label="实时接收时间" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    { prop: 'l1', label: '实时信息标识' },
                    { prop: 'l2', label: '任务标识' },
                    { prop: 'l3', label: '来源系统名称' },
                    { prop: 'l4', label: '信息类型编码' },
                    { prop: 'l5', label: '信息类型名称' },
                    { prop: 'l6', label: '信息总数量' },
                    { prop: 'l7', label: '实时接收时间' },
				],
			}
        },
		computed: {},
		...
		methods: {
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrTransfer/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrTransfer/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
