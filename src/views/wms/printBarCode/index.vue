<template>
  <div class="BarCode-container app-container">
    <el-tabs type="border-card"
             class="HSZ-el_tabs">
      <el-tab-pane label="二维码补打">
        <el-row>
          <el-col :span="16">
            <el-form label-width="100px">
              <el-form-item label="二维码内容">
                <el-input v-model="qrcode"
                          placeholder="输入要生成二维码的字符串">
                  <el-button slot="append"
                             @click="getQRimg">生成</el-button>
                </el-input>
              </el-form-item>
      ...
      <el-tab-pane label="条形码补打">
        <el-row>
          <el-col :span="16">
            <el-form label-width="100px">
              <el-form-item label="条形码内容">
                <el-input v-model="barcode"
                          placeholder="输入要生成条形码的字符串">
                  <el-button slot="append"
                             @click="getBarcode">生成</el-button>
                </el-input>
              </el-form-item>
