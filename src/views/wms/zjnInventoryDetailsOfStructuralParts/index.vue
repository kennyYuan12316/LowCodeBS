    ...
    <div class="HSZ-common-layout-center">
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading" :data="list">
          ...
          <el-table-column label="物料状态" prop="F_InspectionStatus" align="left" width="120">
            <template slot-scope="scope">{{ scope.row.F_InspectionStatus | dynamicTextByenCode(productstypeOptions) }}</template>
          </el-table-column>
          <el-table-column label="是否冻结" prop="F_TestType" sortable="custom" width="100" align="left">
            <template slot-scope="scope">{{ scope.row.F_TestType | dynamicTextByenCode(goodsStateOptions) }}</template>
          </el-table-column>
          <el-table-column prop="F_TheDateOfProduction" label="生产时间" sortable="custom" align="left" width="140">
          ...
          <el-table-column prop="F_TheContainer" label="容器编号" align="left" />
          <el-table-column prop="F_TheTray" label="托盘编号" align="left" />
          ...
          <el-table-column prop="F_ProductsUser" label="仓库" align="left" width="150" />
        </HSZ-table>
        <pagination
          :total="total"
