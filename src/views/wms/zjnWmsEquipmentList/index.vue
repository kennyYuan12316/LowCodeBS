		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="设备编号">
							<el-input v-model="query.F_EquipmentSerialNumber" placeholder="设备编号" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
					...
					<el-col :span="6">
						<el-form-item label="设备名称">
							<el-input v-model="query.F_DeviceName" placeholder="设备名称" clearable />	
						</el-form-item>
					</el-col>
                    <el-col :span="6">
						<el-form-item label="绑定设备">
							<el-input v-model="query.F_TheBinding" placeholder="绑定设备" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="F_EquipmentSerialNumber" label="设备编号" align="left" />
					<el-table-column prop="F_DeviceName" label="设备名称" align="left" />
                    <el-table-column prop="F_TheBinding" label="设备绑定" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    { prop: 'F_EquipmentSerialNumber', label: '设备编号' },
                    { prop: 'F_DeviceName', label: '设备名称' },
                    { prop: 'F_Type', label: '类型' },
				],
				typeOptions:[{'fullName':"只出",'id':"1"},{'fullName':"只入",'id':"2"},{'fullName':"可入可出",'id':"3"}],
			}
        },
		computed: {},
		created() {
		...
		methods: {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnWmsEquipmentList/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnWmsEquipmentList/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnWmsEquipmentList/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
