    ...
    methods: {
      ...
      next() {
        if (this.active == 2) {
          ...
          console.log(datas)
          request({
            url: `/api/wms/ZjnWmsGoods/RawMaterialWarehousingData`,
            method: 'POST',
            data: this.list
          }).then(res => {
        ...
        if (this.active == 1) {
          ...
          request({
            url: `/api/wms/ZjnWmsGoods/ImportPreview`,
            method: 'GET',
            data: datas
          }).then(res => {
      ...
      templateDownload() {
        ...
        request({
          url: `/api/wms/ZjnWmsGoods/TheRawMaterial`,
          method: 'GET',
          data: query
        }).then(res => {
      ...
      exportExceptionData() {
        ...
        //导出错误信息
        request({
          url: `/api/wms/ZjnWmsGoods/ExportExceptionData`,
          method: 'POST',
