		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="系统模块">
							<el-input v-model="query.k2" placeholder="系统模块" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="操作人员">
							<el-input v-model="query.k5" placeholder="操作人员" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="k1" label="日志编号" align="left" />
					<el-table-column prop="k2" label="系统模块" align="left" />
					<el-table-column prop="k3" label="系统标识" align="left" />
					<el-table-column prop="k4" label="请求方式" align="left" />
					<el-table-column prop="k5" label="操作人员" align="left" />
					<el-table-column prop="k6" label="请求系统" align="left" />
					<el-table-column prop="k7" label="响应系统" align="left" />
					<el-table-column prop="k8" label="操作日期" align="left" />
		...
		methods: {
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrError/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrError/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
