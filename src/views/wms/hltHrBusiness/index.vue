		...
		<div class="HSZ-common-layout-center">
			<el-row class="HSZ-common-search-box" :gutter="16">
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="模块组名称">
							<el-input v-model="query.d2" placeholder="模块组名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="模块组编码">
							<el-input v-model="query.d3" placeholder="模块组编码" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="d1" label="编号" align="left" />
					<el-table-column prop="d2" label="模块组名称" align="left" />
					<el-table-column prop="d3" label="模块组编码" align="left" />
					<el-table-column prop="d4" label="所属部门名称" align="left" />
					<el-table-column prop="d5" label="负责人名称" align="left" />
		...
		methods: {
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrBusiness/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrBusiness/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
