		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="部门名称">
							<el-input v-model="query.b1" placeholder="部门名称" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="部门编号">
							<el-input v-model="query.b2" placeholder="部门编号" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="状态">
							<el-input v-model="query.b3" placeholder="状态" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list">
					<el-table-column prop="b1" label="部门名称" align="left" />
					<el-table-column prop="b2" label="部门编号" align="left" />
					<el-table-column prop="b3" label="状态" align="left" />
		...
		methods: {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/HltHrDepartment/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/HltHrDepartment/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
