		...
		<div class="HSZ-common-layout-center">
			<el-row class="HSZ-common-search-box" :gutter="16">
				<el-form @submit.native.prevent>
					...
					<el-col :span="6">
						<el-form-item label="所属仓库编码">
							<el-input v-model="query.F_WareHouseCode" placeholder="所属仓库编码" clearable />	
						</el-form-item>
					</el-col>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					...
					<el-table-column prop="F_WareHouseCode" label="所属仓库编码" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    ...
                    { prop: 'F_WareHouseCode', label: '所属仓库编码' },
		...
		methods: {
			initData() {
                ...
                request({
                    url: `/api/wms/ZjnLimitMaterialInventory`,
                    method: 'GET',
                    data: query
                }).then(res => {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnLimitMaterialInventory/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnLimitMaterialInventory/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnLimitMaterialInventory/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
