		...
		<div class="HSZ-common-layout-center">
			<el-row class="HSZ-common-search-box" :gutter="16">
				<el-form @submit.native.prevent>
					<el-col :span="6">
						<el-form-item label="联接字串">
							<el-select v-model="query.F_PlcConnectionId" placeholder="PLC连接" clearable >
					...
					<el-col :span="6">
						<el-form-item label="设备码">
							<el-input v-model="query.F_DeviceNo" placeholder="设备码" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list">
					<el-table-column label="联接字串" prop="plcConnectionId" align="left">
					...
					<el-table-column prop="F_ObjectType" label="对象类型" align="left" />
					<el-table-column prop="F_DeviceNo" label="设备码" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    { prop: 'F_PlcConnectionId', label: '联接字串' },
                    { prop: 'F_Address', label: '地址' },
                    { prop: 'F_Offset', label: '偏移量' },
                    { prop: 'F_Length', label: '长度' },
                    { prop: 'F_ObjectType', label: '对象类型' },
                    { prop: 'F_DeviceNo', label: '设备码' },
		...
		methods: {
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnPlcRead/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
