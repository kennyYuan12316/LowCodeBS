	...
	<el-dialog :title="!dataForm.id ? '新建' :  isDetail ? '详情':'编辑'" :close-on-click-modal="false" :visible.sync="visible" class="HSZ-dialog HSZ-dialog_center" lock-scroll width="600px">
		<el-row :gutter="15" class="" >
				<el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right" :disabled="!!isDetail" :rules="rules">
					...
					<el-col :span="10">
						<el-form-item label="CPU类型" prop="plcCpuType">
							<el-input v-model='dataForm.plcCpuType' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="10">
						<el-form-item label="rack" prop="rack">
							<el-input v-model='dataForm.rack' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="10">
						<el-form-item label="slot" prop="slot">
							<el-input v-model='dataForm.slot' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="10">
					...
					<el-col :span="10">
						<el-form-item label="机台号" prop="machine">
							<el-input v-model='dataForm.machine' placeholder='请输入' clearable :style='{"width":"100%"}' >
							</el-input>
						</el-form-item>
					</el-col>
				</el-form>
		...
		methods: {
			...
			init(id, isDetail) {
				...
				this.$nextTick(() => {
					...
					if (this.dataForm.id) {
						request({
							url: '/api/wms/ZjnPlcConnection/' + this.dataForm.id,
							method: 'get'
						}).then(res =>{
