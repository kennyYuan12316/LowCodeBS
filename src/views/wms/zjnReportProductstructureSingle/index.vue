		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					...
					<el-col :span="6">
						<el-form-item label="生产线">
							<el-input v-model="query.F_LineNum" placeholder="生产线" clearable />	
						</el-form-item>
					</el-col>
					</template>
					<el-col :span="6">
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					...
					<el-table-column prop="F_SmallMark" label="小属性" align="left" />
	...
	export default {
		...
		methods: {
			initData() {
                ...
                request({
                    url: `/api/wms/ZjnReportProductstructureSingle`,
                    method: 'GET',
                    data: query
                }).then(res => {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnReportProductstructureSingle/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnReportProductstructureSingle/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnReportProductstructureSingle/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
