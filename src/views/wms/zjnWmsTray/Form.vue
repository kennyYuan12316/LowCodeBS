      ...
      <el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right"
        ...
        <el-col :span="24">
          <el-form-item label="托盘编号" prop="trayNo">
            <el-input v-model='dataForm.trayNo' :disabled="this.dataForm.id" placeholder='请输入' clearable required :style='{"width":"100%"}'>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="托盘名称" prop="trayName">
            <el-input v-model='dataForm.trayName' placeholder='请输入' required clearable :style='{"width":"100%"}'>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24">
          <el-form-item label="托盘属性" prop="trayAttr">
            <el-select v-model='dataForm.trayAttr' placeholder='请选择' clearable required :style='{"width":"100%"}'>
        ...
        <el-col :span="24">
          <el-form-item label="托盘状态" prop="trayStates">
            <el-select v-model='dataForm.trayStates' placeholder='请选择' clearable required :style='{"width":"100%"}'>
        ...
        <el-col :span="24">
          <el-form-item label="启用标志" prop="enabledMark">
    ...
    methods: {
      ...
      init(id, isDetail) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            request({
              url: '/api/wms/ZjnWmsTray/' + this.dataForm.id,
              method: 'get'
            }).then(res => {
