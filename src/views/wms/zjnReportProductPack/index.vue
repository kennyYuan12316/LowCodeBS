		...
		<div class="HSZ-common-layout-center">
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					<el-table-column prop="F_RackNum" label="料架号" align="left" />
					<el-table-column prop="F_Label" label="标签条码" align="left" />
					...
					<el-table-column prop="F_CombineType" label="集成方式" align="left" />
					<el-table-column prop="F_ProjectNum" label="项目号" align="left" />
					<el-table-column prop="F_PackingType" label="包装方式" align="left" />
					...
					<el-table-column prop="F_BatteryCapacity" label="电池容量(GWh)" align="left" />
					...
					<el-table-column prop="F_LogicLocation" label="库区" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    { prop: 'F_RackNum', label: '料架号' },
                    { prop: 'F_Label', label: '标签条码' },
                    { prop: 'F_ProductionOrder', label: '生产单号' },
                    { prop: 'F_ProductsCode', label: '物料编码' },
                    { prop: 'F_ProductsName', label: '物料名称' },
                    { prop: 'F_CombineType', label: '集成方式' },
                    { prop: 'F_ProjectNum', label: '项目号' },
                    { prop: 'F_PackingType', label: '包装方式' },
                    ...
                    { prop: 'F_BatteryCapacity', label: '电池容量(GWh)' },
                    { prop: 'F_Ah', label: '安时' },
		...
		methods: {
			initData() {
                ...
                request({
                    url: `/api/wms/ZjnReportProductPack`,
                    method: 'GET',
                    data: query
                }).then(res => {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnReportProductPack/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnReportProductPack/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnReportProductPack/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
