		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					...
					<el-col :span="6">
						<el-form-item label="生产单号">
							<el-input v-model="query.F_ProductionOrder" placeholder="生产单号" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
						<el-form-item label="业务类型">
							<el-input v-model="query.F_BusinessType" placeholder="业务类型" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					...
					<el-table-column prop="F_ComboTime" label="组盘时间" align="left" >
                        <template slot-scope="scope">
                            {{scope.row.F_ComboTime|toDate("yyyy-MM-dd hh:mm:ss")}}
                        </template>
                    </el-table-column>
					...
					<el-table-column prop="F_BusinessType" label="业务类型" align="left" />
	...
	export default {
	    ...
	    data() {
	        ...
	        query: {
	                ...
	                F_ProductionOrder:undefined,
	                F_BusinessType:undefined,
	                F_Batch:undefined,
				},
                list: [],
                listLoading: true,
                ...
                columnList: [
                    ...
                    { prop: 'F_BusinessType', label: '业务类型' },
		...
		methods: {
			initData() {
                ...
                request({
                    url: `/api/wms/ZjnReportProductEntry`,
                    method: 'GET',
                    data: query
                }).then(res => {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnReportProductEntry/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnReportProductEntry/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnReportProductEntry/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
