    ...
    <div class="HSZ-preview-main">
      ...
      <div class="main">
        <el-tabs tab-position="left"
                 ...
                 v-model="category"
                 class="flow-tabs">
          <el-tab-pane label="全部流程"
                       name=""></el-tab-pane>
          <el-tab-pane :label="item.fullName"
                       :name="item.enCode"
              ...
              <el-row :gutter="20"
                ...
                <el-col :span="6"
                  ...
                  <el-card shadow="hover">
                    <div class="box-icon"
                         :style="{backgroundColor:item.iconBackground||'#008cff'}">
                      <i :class="item.icon"></i>
                    </div>
                    <span class="title">{{item.F_work_name}}</span>
                  </el-card>
                </el-col>
              </el-row>
  ...
  methods: {
    ...
    initData () {
      ...
      let query = {
        ...
        F_work_type: this.category == 0 ? '' : this.category
      }
      request({
    url: `/api/wms/ZjnWcsProcessConfig/PageListAll`,
    method: 'get',
    data: query
  }).then((res) => {
    ...
    getDictionaryData () {
      this.$store.dispatch('base/getDictionaryData', { sort: 'liuchengleixing' }).then((res) => {
