		...
		<div class="HSZ-common-layout-center">
				...
				<el-form @submit.native.prevent>
					...
					<el-col :span="6">
						<el-form-item label="物料状态">
							<el-input v-model="query.F_ProductsStatus" placeholder="物料状态" clearable />	
						</el-form-item>
					</el-col>
					<el-col :span="6">
					...
					<el-col :span="6">
						<el-form-item label="出库时间">
							<el-date-picker v-model="query.F_OutTime" type="datetimerange" value-format="timestamp" format="yyyy-MM-dd HH:mm:ss" start-placeholder="开始日期" end-placeholder="结束日期">
							</el-date-picker>
						</el-form-item>
					</el-col>
					</template>
			...
			<div class="HSZ-common-layout-main HSZ-flex-main">
                ...
                <HSZ-table v-loading="listLoading" :data="list" has-c @selection-change="handleSelectionChange">
					...
					<el-table-column prop="F_ProductsStatus" label="物料状态" align="left" />
	    ...
	    data() {
	        ...
	        query: {
                ...
                columnList: [
                    ...
                    { prop: 'F_OutTime', label: '入库时间' },
                    { prop: 'F_BusinessType', label: '业务类型' },
                    { prop: 'F_ProductsStatus', label: '物料状态' },
		...
		methods: {
			...
			handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnBaseOutorder/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            handleBatchRemoveDel() {
                ...
                this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
                    ...
                    request({
                        url: `/api/wms/ZjnBaseOutorder/batchRemove`,
                        method: 'POST',
                        data: ids ,
                    }).then(res => {
                        this.$message({
            ...
            download(data) {
                ...
                request({
                    url: `/api/wms/ZjnBaseOutorder/Actions/Export`,
                    method: 'GET',
                    data: query
                }).then(res => {
