...
export default {
  ...
  data () {
    return {
      ...
      enabledMarkOptions: [{ 'fullName': "启用", 'id': "0" }, { 'fullName': "禁用", 'id': "1" }],
    }
  },
  computed: {},
  created () {
  ...
  methods: {
    ...
    handleBatchRemoveDel () {
      ...
      this.$confirm('您确定要删除这些数据吗, 是否继续？', '提示', {
        ...
        request({
          url: `/api/wms/ZjnHardSrm/batchRemove`,
          method: 'POST',
          data: ids,
        }).then(res => {
          this.$message({
    ...
    download (data) {
      ...
      request({
        url: `/api/wms/ZjnHardSrm/Actions/Export`,
        method: 'GET',
        data: query
      }).then(res => {
