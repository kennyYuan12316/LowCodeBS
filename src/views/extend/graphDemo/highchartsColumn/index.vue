<template>
  <div class="chart-container app-container nohead">
    <el-alert title="免责声明：Highcharts组件不属于合力泰产品，只用于介绍第三方组件如何在《合力泰HR适配器》中使用。如果对这些组件感兴趣，请使用正版。"
              type="warning"
              :closable="false"
              class="mb-10" />
    <div style="float: right;padding-right: 10px; margin-top:20px;">
      <el-button type="primary"
                 icon="icon-sz icon-sz-extend-bar-chart"
                 @click="change('plain')">柱状
      </el-button>
      <el-button type="warning"
                 icon="icon-sz icon-sz-extend-mail-forward"
