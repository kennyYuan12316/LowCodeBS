<template>
  <div class="CommonForm-container app-container nohead">
    <div class="dataForm">
      <el-alert title="普通文本、普通数值、日期时间主键的使用"
                type="warning"
                :closable="false" />
      <el-form ref="dataForm"
        ...
        <el-form-item label="普通文本框">
          <el-input v-model="dataForm.CommonText"
                    placeholder="" />
        </el-form-item>
        ...
        <el-form-item label="自然数">
          <el-input v-model="dataForm.Natural"
                    placeholder=""
                    type="number" />
        </el-form-item>
        <el-form-item label="报销款">
          <el-input v-model="dataForm.Reimbursement"
                    placeholder=""
                    type="number">
        ...
        <el-form-item label="产品价格">
          <el-input v-model="dataForm.ProductPrice"
            ...
            <el-button slot="append"
                       @click="redy">随机设定</el-button>
          </el-input>
        </el-form-item>
        <el-divider content-position="left">日期时间主键的使用</el-divider>
        <!-- format="yyyy-MM-dd HH:mm"  value-format="yyyy-MM-dd HH:mm" -->
        <el-form-item label="生产日期">
          <el-date-picker v-model="dataForm.ProductionDate"
                          type="date"
                          placeholder="选择日期"
        ...
        <el-form-item label="回款日期">
          <el-date-picker v-model="dataForm.ReturnMoneyDate"
                          type="datetime"
                          placeholder="选择日期"
        ...
        <el-form-item label="计划执行日期">
          <el-date-picker v-model="dataForm.PlanExecutionDate"
                          type="datetime"
                          placeholder="选择日期"
                          value-format="yyyy-MM-dd HH:mm:ss">
          </el-date-picker>
        ...
        <el-form-item label="统计月份">
          <el-date-picker v-model="dataForm.StatisticalMonth"
                          type="month"
                          placeholder="选择日期"
        ...
        <el-form-item label="规划日期">
          <el-date-picker v-model="dataForm.Programme"
                          type="date"
                          placeholder="选择日期"
                          value-format="yyyy-MM-dd">
          </el-date-picker>
        ...
        <el-form-item label="日期时间范围">
          <el-date-picker v-model="dataForm.Dates"
                          type="datetimerange"
