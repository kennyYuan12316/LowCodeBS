<template>
  <div class="CommonForm-container app-container nohead">
    <div class="dataForm">
      <el-alert title="查询选择、客户选择、商品选择器"
                type="warning"
                :closable="false" />
      <el-form ref="dataForm"
        ...
        <el-form-item label="用户邮箱">
          <el-col class="mb-10">
            <el-select v-model="emailItem.email"
                       filterable
                       placeholder="选择邮箱"
                       @change="handleChange">
            ...
            <el-input v-model="emailItem.emailText"
                      placeholder="" />
            <el-button type="primary"
                       icon="el-icon-plus"
                       @click="add"></el-button>
          </el-col>
          <el-col v-for="(item,i) in emailList"
                  :key="i"
                  class="mb-10">
            <el-select v-model="item.email"
                       filterable
                       placeholder="选择邮箱"
                       @change="handleChange">
              <el-option v-for="item in options"
            ...
            <el-input v-model="item.emailText"
                      placeholder="" />
            <el-button type="danger"
                       icon="el-icon-close"
                       @click="del(i)"></el-button>
          </el-col>
        </el-form-item>
