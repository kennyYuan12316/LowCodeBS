<template>
  <div class="CommonForm-container app-container HSZ-flex-main">
    <div class="HSZ-common-head">
      ...
      <div class="HSZ-common-head-right">
        ...
        <el-button type="primary"
                   @click="dataFormSubmit()">提交验证</el-button>
      </div>
    </div>
    <div class="dataForm">
      <el-alert title="表单验证"
      ...
      <el-form ref="dataForm"
        ...
        <el-form-item label="确认密码"
                      prop="password2">
          <el-input v-model="dataForm.password2"
                    placeholder="确认密码"
                    type="password"
                    maxlength="20" />
          <span class="tip">必填，包含字母、数字和_-,长度在6-20之间</span>
        ...
        <el-form-item label="信用卡号"
                      prop="creditcard">
          <el-input v-model="dataForm.creditcard"
                    placeholder="信用卡号"
                    maxlength="18" />
        ...
        <el-form-item label="身份证号"
                      prop="cardId">
          <el-input v-model="dataForm.cardId"
                    placeholder="身份证号" />
          <span class="tip">请输入有效的身份证号</span>
        </el-form-item>
        <el-form-item label="RGB"
                      prop="RGB">
          <el-input v-model="dataForm.RGB"
                    placeholder="RGB" />
        ...
        <el-form-item label="英文"
                      prop="english">
          <el-input v-model="dataForm.english"
                    placeholder="英文" />
          <span class="tip">请输入有效的英文字母如：A~Z,a~z</span>
        </el-form-item>
        <el-form-item label="汉字"
                      prop="chinese">
          <el-input v-model="dataForm.chinese"
                    placeholder="汉字" />
        ...
        <el-form-item label="浮点数小于0"
                      prop="floatLtZero">
          <el-input v-model="dataForm.floatLtZero"
                    placeholder="浮点数小于0" />
          <span class="tip">浮点数只能小于0</span>
        </el-form-item>
        <el-form-item label="浮点数大于0"
                      prop="intGtZero">
          <el-input v-model="dataForm.intGtZero"
                    placeholder="浮点数大于0" />
          <span class="tip">浮点数只能大于0</span>
        </el-form-item>
        <el-form-item label="浮点数不等于0"
                      prop="intNEqZero">
          <el-input v-model="dataForm.intNEqZero"
                    placeholder="浮点数不等于0" />
