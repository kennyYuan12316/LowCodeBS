      ...
      <div class="main">
        ...
        <HSZ-table v-loading="listLoading"
          ...
          <el-table-column prop="fullName"
                           ...
                           width="200"
                           fixed="left" />
          <el-table-column prop="signColor"
                           label="标记"
                           width="50"
                           fixed="left">
            <template slot-scope="scope">
              <i class="icon-sz icon-sz-extend-star"
                 :style="'color:' + scope.row.signColor + '!important;'"
                 v-if="scope.row.signColor"></i>
              <i class="icon-sz icon-sz-extend-star-o i-default"
                 v-else></i>
            </template>
          </el-table-column>
          ...
          <el-table-column :resizable="false"
                           ...
                           :key="i.id"
                           align="center">
            <el-table-column class-name="gantt-item"
