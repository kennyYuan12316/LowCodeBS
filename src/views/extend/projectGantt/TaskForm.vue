<template>
  <div>
    <el-dialog :title="!dataForm.id ? '新建任务' : '编辑任务'"
      ...
      <el-form ref="dataForm"
        ...
        <el-form-item label="上级任务"
                      prop="parentId">
          <HSZ-TreeSelect :options="taskTreeData"
        ...
        <el-form-item label="任务工期"
                      prop="timeLimit">
          <el-input-number v-model="dataForm.timeLimit"
                           :step="1"
                           :min="0"
        ...
        <el-form-item label="完成进度"
                      prop="schedule">
          <el-input-number v-model="dataForm.schedule"
                           :precision="2"
                           :step="0.1"
                           :min="0"
                           :max="100"
