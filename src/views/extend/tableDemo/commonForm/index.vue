<template>
  <el-dialog :title="!dataForm.id ? '新建项目' : '编辑项目'"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item label="项目编码"
                    prop="projectCode">
        <el-input v-model="dataForm.projectCode"
                  placeholder="项目编码" />
      </el-form-item>
      ...
      <el-form-item label="立项人"
                    prop="jackStands">
        <el-input v-model="dataForm.jackStands"
                  placeholder="立项人" />
      </el-form-item>
      <el-form-item label="项目类型"
                    prop="projectType">
        <el-select v-model="dataForm.projectType"
                   placeholder="请选择项目类型">
      ...
      <el-form-item label="项目阶段"
                    prop="projectPhase">
        <el-input v-model="dataForm.projectPhase"
                  placeholder="项目阶段" />
      </el-form-item>
      ...
      <el-form-item label="交互日期"
                    prop="interactionDate">
        <el-date-picker v-model="dataForm.interactionDate"
                        type="date"
                        placeholder="选择交互日期"
                        :editable="false"
                        :clearable="false"
      ...
      <el-form-item label="费用金额"
                    prop="costAmount">
        <el-input v-model="dataForm.costAmount"
                  placeholder="费用金额"
                  type="number" />
      </el-form-item>
      <el-form-item label="已用金额"
                    prop="tunesAmount">
        <el-input v-model="dataForm.tunesAmount"
                  placeholder="已用金额"
                  type="number" />
      </el-form-item>
      <el-form-item label="预计收入"
                    prop="projectedIncome">
        <el-input v-model="dataForm.projectedIncome"
                  placeholder="预计收入"
                  type="number" />
      </el-form-item>
