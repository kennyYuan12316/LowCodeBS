      ...
      <div class="HSZ-common-layout-main  HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading"
          ...
          <el-table-column label="项目名称"
            ...
            <template slot-scope="scope">
              <el-input v-model="scope.row.projectName"
                        v-if="tabClickId==scope.row.id"></el-input>
          ...
          <el-table-column label="项目编码"
                           width="160">
            <template slot-scope="scope">
              <el-input v-model="scope.row.projectCode"
                        v-if="tabClickId==scope.row.id"></el-input>
          ...
          <el-table-column label="项目阶段"
                           width="120">
            <template slot-scope="scope">
              <el-input v-model="scope.row.projectPhase"
                        v-if="tabClickId==scope.row.id"></el-input>
          ...
          <el-table-column label="负责人"
                           width="100">
            <template slot-scope="scope">
              <el-input v-model="scope.row.principal"
                        v-if="tabClickId==scope.row.id"></el-input>
          ...
          <el-table-column label="立项人"
                           width="100">
            <template slot-scope="scope">
              <el-input v-model="scope.row.jackStands"
                        v-if="tabClickId==scope.row.id"></el-input>
          ...
          <el-table-column label="交互时间"
                           width="230">
            <template slot-scope="scope">
              <el-date-picker v-model="scope.row.interactionDate"
                              type="date"
                              :editable="false"
                              :clearable="false"
          ...
          <el-table-column label="费用金额"
                           width="100">
            <template slot-scope="scope">
              <el-input v-model="scope.row.costAmount"
                        v-if="tabClickId==scope.row.id"></el-input>
              <span v-else>{{scope.row.costAmount}}</span>
            </template>
          </el-table-column>
          <el-table-column label="已用金额"
                           width="100">
            <template slot-scope="scope">
              <el-input v-model="scope.row.tunesAmount"
                        v-if="tabClickId==scope.row.id"></el-input>
          ...
          <el-table-column label="预计收入"
                           width="100">
            <template slot-scope="scope">
              <el-input v-model="scope.row.projectedIncome"
                        v-if="tabClickId==scope.row.id">
              </el-input>
