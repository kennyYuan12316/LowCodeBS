      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading"
            ...
            <template slot-scope="props">
              <el-tabs v-model="props.row.activeName">
                <el-tab-pane label="订单商品">
                  <el-table :data="props.row.childTable"
                            stripe
                            size='mini'
                            show-summary
                ...
                <el-tab-pane label="收款计划">
                  <el-table :data="props.row.childTable1"
                            stripe
                            size='mini'
                            show-summary
                            :element-loading-text="$t('common.loadingText')">
          ...
          <el-table-column prop="customerName"
                           ...
                           width="220"
                           sortable="custom" />
          <el-table-column prop="salesmanName"
                           label="业务人员"
                           width="120"
                           sortable="custom" />
          <el-table-column prop="receivableMoney"
                           ...
                           width="100"
                           sortable="custom" />
          <el-table-column prop="creatorUser"
                           label="制单人员"
                           width="120" />
          <el-table-column prop="description"
                           label="订单备注"
                           show-overflow-tooltip />
          <el-table-column prop="currentState"
                           label="状态"
                           width="100"
                           sortable="custom">
            <template slot-scope="scope">
              ...
              <el-tag type="success"
                      v-else-if="scope.row.currentState==2">审核通过</el-tag>
              <el-tag type="danger"
                      v-else-if="scope.row.currentState==3">审核驳回</el-tag>
              <el-tag type="danger"
                      v-else-if="scope.row.currentState==4">流程撤回</el-tag>
              <el-tag type="warning"
                      v-else-if="scope.row.currentState==5">审核终止</el-tag>
              <el-tag type="info"
                      v-else>等待提交</el-tag>
            </template>
          </el-table-column>
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              <el-button size="mini"
                         ...
                         :disabled="[1,2,5].indexOf(scope.row.currentState)>-1"
                         v-has="'btn_edit'">编辑
              </el-button>
              <el-button size="mini"
                         type="text"
                         ...
                         :disabled="[1,2,3,5].indexOf(scope.row.currentState)>-1"
                         v-has="'btn_remove'">删除
              </el-button>
              <el-button size="mini"
                         type="text"
