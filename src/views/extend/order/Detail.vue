                ...
                <el-form-item label="相关附件"
                  ...
                  <ul class="el-upload-list el-upload-list--text">
                    <li class="el-upload-list__item"
                      ...
                      <a class="el-upload-list__item-name"><i class="el-icon-document"></i>{{item.fileName}}
                      </a>
                    </li>
                  </ul>
                </el-form-item>
      ...
      this.$nextTick(() => {
        if (this.dataForm.id) {
          ...
          Info('crmOrder', this.dataForm.id).then(res => {
            ...
            this.dataForm.orderDate = this.hsz.toDate(this.dataForm.orderDate)
            this.dataForm.deliveryDate = this.hsz.toDate(this.dataForm.deliveryDate, "yyyy-MM-dd")
