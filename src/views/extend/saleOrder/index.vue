<template>
  <div class="HSZ-common-layout sale-order-main">
    <div class="HSZ-common-layout-center">
        ...
        <el-form @submit.native.prevent>
          ...
          <el-col :span="6">
            <el-form-item label="审核状态">
              <el-select v-model="query.auditState"
                         placeholder="选择审核状态"
                         clearable>
                <el-option label="全部"
                           :value="0" />
          ...
          <template v-if="showAll">
            <el-col :span="6">
              <el-form-item label="关闭状态">
                <el-select v-model="query.closeState"
                           placeholder="选择关闭状态"
                           clearable>
                  <el-option label="全部"
                             :value="0" />
            ...
            <el-col :span="6">
              <el-form-item label="制单人">
                <el-input v-model="query.creatorUser"
                          placeholder="请输入制单人"
                          clearable />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="6">
              <el-form-item label="联系方式">
                <el-input v-model="query.contactTel"
                          placeholder="请输入联系方式"
                          clearable />
              </el-form-item>
            </el-col>
      ...
      <div class="HSZ-common-layout-main HSZ-flex-main">
        ...
        <HSZ-table v-loading="listLoading"
          ...
          <el-table-column prop="goodsState"
                           label="发货通知状态"
                           width="100">
            <template slot-scope="scope">
          ...
          <el-table-column prop="closeState"
                           label="关闭状态"
                           width="100">
            <template slot-scope="scope">
        ...
        <div class="sale-order-footer">
          <HSZ-table :data="productEntryList"
                     highlight-current-row
                     @row-click="rowClick1">
          ...
          <HSZ-table :data="childrenList"
            ...
            <el-table-column prop="money"
                             label="折后单价" />
            <el-table-column prop="commandType"
                             label="控制方式" />
            <el-table-column prop="util"
                             label="单位" />
          </HSZ-table>
        </div>
      </div>
