<template>
  <transition name="el-zoom-in-center">
    <div class="HSZ-preview-main order-form">
      <div class="HSZ-common-page-header">
        <el-page-header @back="goBack"
                        :content="dataForm.id?'编辑':'新建'" />
        <div class="options">
      ...
      <div class="main"
          ...
          <el-row>
            <el-col :span="18">
              ...
              <el-col :span="8">
                <el-form-item label="联系方式"
                              prop="contactTel">
                  <el-input v-model="dataForm.contactTel"
                            placeholder="联系方式">
                  </el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="8">
                <el-form-item label="发货仓库"
                              prop="goodsWarehouse">
                  <el-select v-model="dataForm.goodsWarehouse"
                             placeholder="发货仓库">
                    <el-option :key="item"
                               :label="item"
                               :value="item"
              ...
              <el-col :span="8">
                <el-form-item label="业务员"
                              prop="business">
                  <el-input v-model="dataForm.business"
                            placeholder="业务员">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="收款方式"
                              prop="gatheringType">
                  <el-select v-model="dataForm.gatheringType"
                             placeholder="选择收款方式">
                    <el-option :key="item"
                               :label="item"
                               :value="item"
              ...
              <el-col :span="8">
                <el-form-item label="让利金额"
                              prop="partPrice">
                  <el-input v-model="dataForm.partPrice"
                            placeholder="让利金额">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="优惠金额"
                              prop="reducedPrice">
                  <el-input v-model="dataForm.reducedPrice"
                            placeholder="优惠金额">
                  </el-input>
                </el-form-item>
              </el-col>
            ...
            <el-col :span="6">
              <el-form-item label="审核人"
                            label-width="120px"
                            prop="auditName">
                <el-input v-model="dataForm.auditName"
                          disabled />
              </el-form-item>
              ...
              <el-form-item label="发货通知人"
                            label-width="120px"
                            prop="goodsName">
                <el-input v-model="dataForm.goodsName"
                          disabled />
              </el-form-item>
              <el-form-item label="发货通知时间"
                            label-width="120px"
                            prop="goodsDate">
                <el-input v-model="dataForm.goodsDate"
                          disabled />
              </el-form-item>
              <el-form-item label="收货仓库"
                            label-width="120px"
                            prop="harvestWarehouse">
                <el-input v-model="dataForm.harvestWarehouse"
                          disabled />
              </el-form-item>
              <el-form-item label="代发客户"
                            label-width="120px"
                            prop="issuingName">
                <el-input v-model="dataForm.issuingName"
                          disabled />
              </el-form-item>
            </el-col>
          </el-row>
        ...
        <el-row class="add-btn">
          <el-col :span="18">
            <el-button type="primary"
                       icon="el-icon-plus"
                       @click="openGoodsBox">选择产品</el-button>
          </el-col>
          <el-col :span="6">
        ...
        <HSZ-table :data="dataForm.productEntryList"
                   size='small'>
          ...
          <el-table-column prop="productCode"
                           ...
                           width="200">
            <template slot-scope="scope">
              <el-autocomplete v-model="scope.row.productCode"
                               :fetch-suggestions="goodsSearchAsync"
                               placeholder="商品编码"
                               @select="goodsSelect($event,scope.row)"
                               style="width:100%"
          ...
          <el-table-column prop="productName"
                           label="商品名称" />
          <el-table-column prop="productSpecification"
                           label="规格型号"
                           width="100" />
          ...
          <el-table-column prop="qty"
                           ...
                           width="120">
            <template slot-scope="scope">
              <el-input-number v-model="scope.row.qty"
...
export default {
  ...
  methods: {
    ...
    count (row) {
      row.amount = this.hsz.toDecimal(parseFloat(row.money) * parseFloat(row.qty))
    },
    openGoodsBox () {
