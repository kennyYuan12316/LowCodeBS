    ...
    <div class="HSZ-preview-main">
      ...
      <el-form ref="dataForm"
        ...
        <el-form-item label="收件人"
                      prop="recipient">
          <el-select v-model="dataForm.recipient"
                     multiple
                     filterable
                     allow-create
                     ...
                     placeholder="收件人"
                     title="输入完按回车"
                     popper-class="HSZ-select-tags">
          </el-select>
        </el-form-item>
        <el-form-item label="抄送人"
                      prop="cc"
                      v-if="showCC">
          <el-select v-model="dataForm.cc"
                     multiple
                     filterable
                     allow-create
                     default-first-option
        ...
        <el-form-item label="密送人"
                      prop="bcc"
                      v-if="showBCC">
          <el-select v-model="dataForm.bcc"
                     multiple
                     filterable
                     allow-create
                     default-first-option
        ...
        <el-form-item label="正文"
                      prop="bodyText">
          <HSZ-Quill v-model="dataForm.bodyText" />
        </el-form-item>
      </el-form>
    </div>
  </transition>
