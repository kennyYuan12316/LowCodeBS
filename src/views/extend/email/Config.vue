  ...
  <el-dialog title="邮箱配置"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item label="POP3服务"
                    prop="pop3Host">
        <el-input v-model="dataForm.pop3Host"
                  placeholder="POP3服务" />
      </el-form-item>
      <el-form-item label="POP3端口"
                    prop="pop3Port">
        <el-input-number v-model="dataForm.pop3Port"
                         controls-position="right"></el-input-number>
      </el-form-item>
      <el-form-item label="SMTP服务"
                    prop="smtpHost">
        <el-input v-model="dataForm.smtpHost"
                  placeholder="SMTP服务" />
      </el-form-item>
      <el-form-item label="SMTP端口"
                    prop="smtpPort">
        <el-input-number v-model="dataForm.smtpPort"
                         controls-position="right"></el-input-number>
      </el-form-item>
      <el-form-item label="显示名称"
                    prop="senderName">
        <el-input v-model="dataForm.senderName"
                  placeholder="显示名称" />
      </el-form-item>
      ...
      <el-form-item label="SSL登录"
                    prop="emailSsl">
        <el-switch v-model="dataForm.emailSsl"
                   :active-value="1"
                   :inactive-value="0">
        </el-switch>
      </el-form-item>
