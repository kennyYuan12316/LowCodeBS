    ...
    <div class="HSZ-preview-main">
      <div class="HSZ-common-page-header">
        <el-page-header @back="goBack"
                        :content="!dataForm.table ? '新建表名' : '编辑表名'" />
        <div class="options">
      ...
      <div class="main">
        <el-form :inline="true"
          ...
          <el-form-item label="表名称"
                        prop="newTable">
            <el-input v-model="dataForm.newTable"
                      placeholder="表名称"
                      maxlength="50"></el-input>
          </el-form-item>
          <el-form-item label="表说明"
                        prop="tableName">
            <el-input v-model="dataForm.tableName"
                      placeholder="表说明"></el-input>
          </el-form-item>
        </el-form>
          ...
          <div class="options">
            <el-dropdown :disabled="!fieldList.length">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="addHandle(item)"
        ...
        <el-table v-loading="listLoading"
          ...
          <el-table-column prop="dataLength"
                           label="长度">
            <template slot-scope="scope">
              <el-input v-model="scope.row.dataLength"
                        placeholder="请输入长度"
                        :disabled="scope.row.dataType!=='varchar'" />
            </template>
          </el-table-column>
          <el-table-column prop="primaryKey"
                           label="是否主键"
                           width="70"
                           align="center">
            <template slot-scope="scope">
          ...
          <el-table-column prop="allowNull"
                           label="允许空"
                           width="60"
                           align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="操作"
                           width="50">
            <template slot-scope="scope">
              <el-button class="HSZ-table-delBtn"
                         size="mini"
                         type="text"
        ...
        <div class="table-actions"
             @click="addHandle()">
          <el-button type="text"
                     icon="el-icon-plus">新建字段</el-button>
        </div>
      </div>
    </div>
  </transition>
