<template>
  <div class="HSZ-preview-main flow-form-main">
    <div class="HSZ-common-page-header">
      ...
      <div class="options">
        <el-button :disabled="active <= 0"
                   @click="handlePrevStep">{{$t('common.prev')}}
        </el-button>
        <el-button :disabled="active >= 1"
                   @click="handleNextStep">{{$t('common.next')}}
        </el-button>
      ...
      <el-row>
        <el-col :span="14"
          ...
          <el-form-item label="分类"
                        prop="categoryId">
            <HSZ-TreeSelect v-model="dataForm.categoryId"
                            :options="selectData"
                            placeholder="选择分类"
                            clearable />
          </el-form-item>
          ...
          <el-form-item prop="ipAddress"
                        v-if="dataForm.checkType===2">
            <el-input v-model="dataForm.ipAddress"
                      placeholder="请输入域名，多个域名用逗号隔开" />
          </el-form-item>
          ...
          <el-form-item label="动作"
            ...
            <el-radio-group v-model="dataForm.requestMethod"
                            @change="onMethodChange($event,'sql')">
          ...
          <el-form-item label="动作"
            ...
            <el-radio-group v-model="dataForm.requestMethod"
                            @change="onMethodChange($event,'api')">
    ...
    <div class="config"
         v-if="active === 1 && dataForm.dataType === 1">
      <div class="tableData">
        <el-select v-model="dataForm.dbLinkId"
                   filterable
                   placeholder="选择数据库"
                   style="width: 100%"
                   @change="handleSelectTable">
          <el-option-group v-for="group in dbOptions"
                           :key="group.fullName"
          ...
          <el-tab-pane label="查询SQL"
            ...
            <el-form ref="dataForm"
              ...
              <el-form-item label-width="0"
                            prop="query">
                <div class="sql-box">
                  <SQLEditor v-model="dataForm.query"
                             :options="sqlOptions"
                             ref="SQLEditorRef" />
                </div>
              </el-form-item>
      ...
      <div class="right-pane">
        <div class="right-pane-list">
          ...
          <div class="list">
            <el-table :data="requestParameters"
                      ref="dragTable"
                      row-key="id"
                      size='mini'
                      height="100%">
              ...
              <el-table-column prop="field"
                ...
                <template slot-scope="scope">
                  <p @click="handleItemClick(scope.row)"
          ...
          <div class="table-actions"
            ...
            <el-button type="text"
                       icon="el-icon-plus">添加参数</el-button>
          </div>
        </div>
    ...
    <div class="staticData"
         v-if="active === 1 && dataForm.dataType === 2">
      <el-form ref="dataForm"
               :model="dataForm"
               :rules="dataRule"
               label-width="100px">
        <el-form-item label-width="0"
                      prop="query">
          <div class="json-box">
            <JSONEditor v-model="dataForm.query"
                        :options="jsonOptions"
                        ref="JSONEditorRef" />
          </div>
        </el-form-item>
    ...
    <el-form ref="dataForm"
      ...
      <el-row>
        <el-col :span="14"
          ...
          <el-form-item label="接口headers"
                        prop="requestHeaders">
            <el-button @click="addHeaders()"
                       class="el-icon-plus"
                       size="mini">添加headers
            </el-button>
            <el-row v-for="(item, index) in requestHeaders"
                    :key="item.index"
                    class="mt-10">
              <el-col :span="10">
                <el-autocomplete v-model="item.field"
    ...
    <FieldForm v-show="fieldFormVisible"
               ref="fieldForm"
...
import SQLEditor from '@/components/HSZEditor/monaco'
import JSONEditor from '@/components/HSZEditor/monaco'
