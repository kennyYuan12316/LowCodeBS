    ...
    <div class="HSZ-preview-main">
      ...
      <div class="main">
        ...
        <HSZ-table v-loading="listLoading"
                   :data="list">
          <el-table-column prop="invokTime"
                           label="请求时间"
          ...
          <el-table-column prop="userId"
                           label="请求用户"
                           width="120" />
          <el-table-column prop="invokIp"
                           label="请求IP"
                           width="120" />
          <el-table-column prop="invokDevice"
                           label="请求设备"
                           show-overflow-tooltip />
          <el-table-column prop="invokType"
                           label="请求类型"
                           width="80"
                           align="center" />
          <el-table-column prop="invokWasteTime"
                           label="耗时(毫秒)"
                           width="80" />
        </HSZ-table>
