<template>
  <el-dialog :title="!dataForm.id ? '新建参数' : '编辑参数'"
    ...
    <el-form ref="fieldForm"
      ...
      <el-form-item label="参数名称"
                    prop="field">
        <el-input v-model="dataForm.field"
                  placeholder="参数名称" />
      </el-form-item>
      <el-form-item label="参数说明"
                    prop="fieldName">
        <el-input v-model="dataForm.fieldName"
                  placeholder="参数说明" />
      </el-form-item>
      ...
      <el-form-item label="默认值"
                    prop="defaultValue">
        <el-input v-model="dataForm.defaultValue"
                  placeholder="默认值" />
      </el-form-item>
      <el-form-item label="必填"
                    prop="required">
        <el-switch v-model="dataForm.required"
                   :active-value="1"
                   :inactive-value="0" />
      </el-form-item>
    </el-form>
    ...
    init (dataForm, list) {
      ...
      this.$nextTick(() => {
        if (dataForm) {
          ...
          this.dataForm.id = this.hsz.idGenerator()
          this.type = 'add'
        }
      })
    },
