<template>
  <el-dialog :title="!dataForm.id ? '新建连接' : '编辑连接'"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item label="连接驱动"
                    prop="dbType">
        <el-select v-model="dataForm.dbType"
                   placeholder="请选择"
      ...
      <el-form-item label="端口"
                    prop="port">
        <el-input v-model.number="dataForm.port"
                  placeholder="端口" />
      </el-form-item>
      ...
      <template v-if="dataForm.dbType==='MySQL'">
        <el-form-item label="库名"
                      prop="serviceName">
          <el-input v-model="dataForm.serviceName"
                    placeholder="库名">
            <el-button slot="append"
                       @click="test"
                       :loading="testLoad">测试连接</el-button>
          </el-input>
        </el-form-item>
      </template>
      <template v-if="dataForm.dbType==='SQLServer'||dataForm.dbType==='PostgreSQL'||dataForm.dbType==='KingbaseES'">
        <el-form-item label="库名"
                      prop="serviceName">
          <el-input v-model="dataForm.serviceName"
                    placeholder="库名"></el-input>
        </el-form-item>
        <el-form-item label="模式"
                      prop="dbSchema">
          <el-input v-model="dataForm.dbSchema"
                    :disabled="true"
          ...
          <el-input v-model="dataForm.dbSchema"
                    v-if="dataForm.dbType==='KingbaseES'">
            <el-button slot="append"
                       @click="test"
                       :loading="testLoad">测试连接</el-button>
          </el-input>
      ...
      <template v-if="dataForm.dbType==='Oracle'">
        ...
        <template v-if="dataForm.oracleExtend">
          <el-form-item label="连接方式"
                        prop="oracleLinkType">
            <el-select v-model="dataForm.oracleLinkType"
                       placeholder="请选择">
              <el-option label="SERVICE"
                         value="SERVICE"></el-option>
              <el-option label="SID"
                         value="SID"></el-option>
              <el-option label="SCHEMA"
                         value="SCHEMA"></el-option>
              <el-option label="TNS"
                         value="TNS"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="角色"
                        prop="oracleRole">
            <el-select v-model="dataForm.oracleRole"
                       placeholder="请选择">
              <el-option label="Default"
                         value="Default"></el-option>
              <el-option label="SYSDBA"
                         value="SYSDBA"></el-option>
              <el-option label="SYSOPER"
                         value="SYSOPER"></el-option>
            </el-select>
          </el-form-item>
