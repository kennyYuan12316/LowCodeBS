<template>
  <div class="HSZ-common-layout MessageRecord-container">
            ...
            <HSZ-table v-loading="listLoading"
              ...
              <el-table-column prop="title"
                ...
                <template slot-scope="scope">
                  <el-link @click="readInfo(scope.row)"
                           style="font-size:12px">{{ scope.row.title }}
                  </el-link>
                </template>
              </el-table-column>
              ...
              <el-table-column prop="isRead"
                ...
                <template slot-scope="scope">
                  <el-tag type="success"
                          v-if="scope.row.isRead=='1'">已读</el-tag>
                  <el-tag type="info"
                          v-else>未读</el-tag>
                </template>
              </el-table-column>
