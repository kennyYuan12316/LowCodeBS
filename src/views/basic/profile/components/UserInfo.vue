        ...
        <el-col :span="12">
          <el-form :model="form"
            ...
            <el-form-item label="注册时间">
              <el-input v-model="creatorTime"
                        readonly />
            </el-form-item>
            <el-form-item label="上次登录时间">
              <el-input v-model="prevLogTime"
                        readonly />
            </el-form-item>
            <el-form-item label="入职日期">
              <el-input v-model="entryDate"
                        readonly />
            </el-form-item>
          </el-form>
        </el-col>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="民族">
                <el-select v-model="form2.nation"
                           placeholder="选择民族"
                           filterable>
            ...
            <el-col :span="12">
              <el-form-item label="证件类型">
                <el-select v-model="form2.certificatesType"
                           placeholder="请选择类型">
                  <el-option v-for="item in certificatesTypeOptions"
                             :key="item.id"
                             :label="item.fullName"
                             :value="item.id">
                  </el-option>
            ...
            <el-col :span="12">
              <el-form-item label="文化程度">
                <el-select v-model="form2.education"
                           placeholder="请选择学历">
            ...
            <el-col :span="12">
              <el-form-item label="出生年月">
                <el-date-picker v-model="form2.birthday"
                                type="date"
                                placeholder="选择日期"
            ...
            <el-col :span="24">
              <el-form-item label="自我介绍">
                <el-input v-model="form2.signature"
                          type="textarea"
                          :rows="3" />
              </el-form-item>
            </el-col>
...
export default {
  ...
  computed: {
    creatorTime () {
      return this.hsz.toDate(this.form.creatorTime)
    },
    entryDate () {
      return this.hsz.toDate(this.form.entryDate)
    },
    prevLogTime () {
      return this.hsz.toDate(this.form.prevLogTime)
    },
  },
  created () {
    this.getOptions()
