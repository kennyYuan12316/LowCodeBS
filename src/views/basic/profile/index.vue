  ...
  <div class="app-container Profile-container">
    <el-tabs tab-position="left"
      ...
      <el-tab-pane disabled
                   name="line"></el-tab-pane>
      <el-tab-pane label="我的下属"
                   name="subordinate">
        <div class="HSZ-common-title mb-10">
        ...
        <div class="subordinate-list">
          <el-tree :data="treeData"
                   ...
                   v-loading="loading"
                   :load="loadNode"
                   class="HSZ-common-el-tree subordinate-tree">
            <el-card class="subordinate-tree-node"
                     shadow="never"
                     slot-scope="{ data }">
              <el-avatar :size="50"
                         :src="define.comUrl+ data.avatar"></el-avatar>
              <div class="text">
                <p>{{data.userName}}</p>
          ...
          <el-row :gutter="80"
            ...
            <el-col :span="12"
              ...
              <div class="organize-item-main"
                ...
                <i class="icon-sz icon-sz-wf-outgoingApply"></i>
                <p class="organize-name">{{item.fullName}}</p>
                <p class="btn">主岗</p>
                <div class="icon-checked">
                  <i class="el-icon-check"></i>
