				...
				<el-form ref="elForm" :model="dataForm" size="small" label-width="100px" label-position="right" :disabled="!!isDetail" :rules="rules">
					<el-col :span="24">
						<el-form-item label-width="0">
							<HSZ-Text value="Agv请求取放" :textStyle='{"color":"#000000","text-align":"center","font-weight":"bold","font-style":"normal","text-decoration":"none","line-height":32,"font-size":20}' :style='{"width":"100%"}'></HSZ-Text>
						</el-form-item>
					</el-col>
					<el-col :span="24">
		...
		methods: {
			...
			init(id, isDetail) {
				...
				this.$nextTick(() => {
					...
					if (this.dataForm.id) {
						request({
							url: '/api/agv/ZjnBaseStdLimitgoods/' + this.dataForm.id,
							method: 'get'
						}).then(res =>{
