<template>
  <div class="app-container HSZ-flex-main authorize-container">
    <div class="HSZ-common-head">
      ...
      <div class="btn-group">
        ...
        <el-button :disabled="active <= 0 || treeLoading"
                   @click="handlePrevStep">
          {{$t('common.prev')}}</el-button>
        <el-button :disabled="active >= 5 || treeLoading"
    ...
    <div class="authorize-bd">
      <div v-if="active < 5">
        <el-tree :data="authorizeTreeData"
                 ref="authorizeTree"
      ...
      <div class="authorize-selectbox"
           v-else>
        <el-tree :data="roleTreeAllData"
                 ref="roleTree"
