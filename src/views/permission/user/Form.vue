<template>
  <transition name="el-zoom-in-center">
    <div class="HSZ-preview-main user-form">
          ...
          <el-row :gutter="20"
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="性别"
                ...
                <el-select v-model="dataForm.gender"
                           placeholder="选择性别">
                  <el-option v-for="item in genderTreeData"
                             :key="item.enCode"
                             :label="item.fullName"
                             :value="item.enCode" />
                </el-select>
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="所属组织"
                            prop="organizeIdTree">
                <ComSelect v-model="dataForm.organizeIdTree"
                           placeholder="选择所属组织"
                           multiple
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="岗位"
                ...
                <el-select v-model="positionId"
                           ...
                           filterable
                           clearable>
                  <el-option-group v-for="group in positionTreeData"
                                   :key="group.id"
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="角色"
                ...
                <el-select v-model="roleId"
                           ...
                           filterable
                           clearable>
                  <el-option-group v-for="group in roleTreeData"
                                   :key="group.id"
                                   :label="group.fullName+(group.num?'【'+group.num+'】':'')">
                    <el-option v-for="item in group.children"
                               :key="group.id+item.id"
            ...
            <el-col :span="12">
              <el-form-item label="状态"
                            prop="enabledMark">
                <el-select v-model="dataForm.enabledMark"
                           placeholder="选择状态">
                  <el-option label="正常"
                             :value="1" />
                  <el-option label="锁定"
          ...
          <el-row :gutter="20"
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="民族"
                ...
                <el-select v-model="dataForm.nation"
                           placeholder="选择民族"
                           filterable>
                  <el-option v-for="item in nationTreeData"
                             :key="item.id"
                             :label="item.fullName"
                             :value="item.id" />
                </el-select>
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="入职时间"
                            prop="entryDate">
                <el-date-picker v-model="dataForm.entryDate"
                                type="date"
                                placeholder="选择入职时间"
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="证件类型"
                ...
                <el-select v-model="dataForm.certificatesType"
                           placeholder="选择证件类型">
                  <el-option v-for="item in certificatesTypeTreeData"
                             :key="item.id"
                             :label="item.fullName"
                             :value="item.id" />
                </el-select>
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="证件号码"
                ...
                <el-input v-model="dataForm.certificatesNumber"
                          placeholder="证件号码" />
              </el-form-item>
            </el-col>
            <el-col :sm="12"
              ...
              <el-form-item label="文化程度"
                ...
                <el-select v-model="dataForm.education"
                           placeholder="选择文化程度">
                  <el-option v-for="item in educationTreeData"
                             :key="item.id"
                             :label="item.fullName"
                             :value="item.id" />
                </el-select>
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="办公座机"
                            prop="landline">
                <el-input v-model="dataForm.landline"
                          placeholder="办公座机" />
              </el-form-item>
            </el-col>
            <el-col :sm="12"
            ...
            <el-col :sm="12"
              ...
              <el-form-item label="紧急联系"
                            prop="urgentContacts">
                <el-input v-model="dataForm.urgentContacts"
                          placeholder="紧急联系人" />
              </el-form-item>
            </el-col>
            <el-col :sm="12"
              ...
              <el-form-item label="紧急电话"
                            prop="urgentTelePhone">
                <el-input v-model="dataForm.urgentTelePhone"
                          placeholder="紧急联系人电话" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="通讯地址"
                            prop="postalAddress">
                <el-input v-model="dataForm.postalAddress"
                          type="textarea"
                          :rows="6" />
              </el-form-item>
            </el-col>
