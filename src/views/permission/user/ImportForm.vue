    ...
    <div class="import-main"
      ...
      <div class="upload">
        ...
        <div class="up_right">
          ...
          <el-button type="text"
                     @click="templateDownload">下载模板</el-button>
        </div>
      </div>
    </div>
    <div class="import-main"
      ...
      <HSZ-table v-loading="listLoading"
        ...
        <el-table-column prop="organizeId"
                         label="所属组织"
                         width="150">
          <template slot-scope="scope">
        ...
        <el-table-column prop="certificatesType"
                         label="证件类型"
                         width="150">
          <template slot-scope="scope">
        ...
        <el-table-column prop="urgentContacts"
                         label="紧急联系"
                         width="150">
          <template slot-scope="scope">
        ...
        <el-table-column prop="urgentTelePhone"
                         label="紧急电话"
                         width="150">
          <template slot-scope="scope">
    ...
    <div class="import-main"
      ...
      <div class="unsuccess"
        ...
        <div class="upload error-show">
          ...
          <div class="up_right">
            <p class="tip">正常数量条数：<el-link type="success"
                       :underline="false">{{result.snum}}条
              </el-link>
            </p>
            <p class="tip">异常数量条数：<el-link type="danger"
                       :underline="false">{{result.fnum}}条
              </el-link>
            </p>
          </div>
        </div>
        <div class="contips">
          ...
          <el-button type="text"
                     ...
                     @click="exportExceptionData">导出异常数据
          </el-button>
        </div>
        <HSZ-table :data="resultList"
                   height="280px">
          <el-table-column prop="account"
                           label="账户"
                           width="150" />
