  ...
  <el-dialog title="分级管理"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item label="组织操作权限(本层级)">
        <el-checkbox v-model="dataForm.thisLayerAdd"
                     :true-label="1"
                     :false-label="0">添加
        </el-checkbox>
        <el-checkbox v-model="dataForm.thisLayerEdit"
                     :true-label="1"
                     :false-label="0">编辑
        </el-checkbox>
        <el-checkbox v-model="dataForm.thisLayerDelete"
                     :true-label="1"
                     :false-label="0">删除
        </el-checkbox>
      </el-form-item>
      <el-form-item label="子组织操作权限(子层级)">
        <el-checkbox v-model="dataForm.subLayerAdd"
                     :true-label="1"
                     :false-label="0">添加
        </el-checkbox>
        <el-checkbox v-model="dataForm.subLayerEdit"
                     :true-label="1"
                     :false-label="0">编辑
        </el-checkbox>
        <el-checkbox v-model="dataForm.subLayerDelete"
                     :true-label="1"
                     :false-label="0">删除
        </el-checkbox>
      </el-form-item>
