<template>
  <div class="login-container">
    <div class="login-version"
         v-if="sysConfig && sysConfig.sysVersion">
      <p class="login-version-text">{{sysConfig.sysVersion}}</p>
    </div>
    <div class="login-left">
      <!-- <a class="login-company-logo"
         target="_blank"
         href="https://www.hszsoft.com">
        <img class="login-company-logo-img"
      ...
      <div class="login-left-txt"
        ...
        <a class="link"
           target="_blank"
           href="https://www.hszsoft.com">了解更多</a>
      </div>
    </div>
    <div class="login-content">
      <div class="login-form">
          ...
          <el-form-item prop="code"
            ...
            <el-row type="flex"
              ...
              <el-col class="sms-right code-right">
                <el-tooltip :content="$t('login.changeCode')"
                            placement="bottom">
                  <img id="imgcode"
        ...
        <div v-show="active==2"
             class="login-form-QRCode">
          <img class="qrcode-img"
               src="../../assets/images/login_qr.png">
          <p class="qrcode-tip">正在测试,稍后上线</p>
        </div>
      </div>
    </div>
    <!-- <div class="login-foot">Copyright 江西合力泰科技股份有限公司, All Rights Reserved. 沪ICP备17044791号-1
      助力企业和团队快速实现目标</div> -->
  </div>
</template>
