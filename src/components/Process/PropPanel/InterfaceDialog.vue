<template>
  <div class="popupSelect-container">
    ...
    <el-dialog title="接口模板"
               :close-on-click-modal="false"
               :visible.sync="visible"
               class="HSZ-dialog HSZ-dialog_center HSZ-dialog-tree-select"
               lock-scroll
               append-to-body
               width="1000px">
      <div class="HSZ-common-layout">
        <div class="HSZ-common-layout-left">
          <el-scrollbar class="HSZ-common-el-tree-scrollbar"
            ...
            <el-form @submit.native.prevent>
              ...
              <el-col :span="8"
                ...
                <el-form-item label="类型">
                  <el-select v-model="query.dataType"
                             placeholder="请选择"
                             clearable>
                    <el-option label="SQL操作"
                               :value="1"></el-option>
                    <el-option label="静态数据"
                               :value="2"></el-option>
                    <el-option label="Api数据"
                               :value="3"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
          ...
          <div class="HSZ-common-layout-main HSZ-flex-main">
            <HSZ-table v-loading="listLoading"
              ...
              <el-table-column type="expand"
                               width="40">
                <template slot-scope="scope">
                  <el-table :data="scope.row.templateJson"
                            size='mini'>
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="select()">{{$t('common.confirmButton')}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
