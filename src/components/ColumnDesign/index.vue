<template>
  <div class="columnDesign-box">
    <column-main ref="columnMain"
                 :conf="columnData"
                 :modelType="modelType"
                 v-show="currentTab==='pc'" />
    <column-main-app ref="columnMainApp"
                     :conf="appColumnData"
                     :modelType="modelType"
                     v-show="currentTab==='app'" />
    <div class="head-tabs">
      <div class="head-tabs-item"
           :class="{'active':currentTab==='pc'}"
           @click="currentTab='pc'">
        桌面端<i class="icon-sz icon-sz-pc"></i></div>
      <el-divider direction="vertical"></el-divider>
      <div class="head-tabs-item"
           :class="{'active':currentTab==='app'}"
           @click="currentTab='app'">
        移动端<i class="icon-sz icon-sz-mobile"></i>
      </div>
    </div>
  </div>
</template>
