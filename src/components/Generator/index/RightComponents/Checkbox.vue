<template>
  <el-row>
    ...
    <el-form-item label="默认值">
      <el-checkbox-group v-model="activeData.__config__.defaultValue"
                         :min="activeData.min"
                         :max="activeData.max">
    ...
    <template v-if="activeData.__config__.dataType === 'dictionary'">
      <el-form-item label="远端数据">
        <HSZ-TreeSelect :options="treeData"
      ...
      <el-form-item label="存储字段">
        <el-select v-model="activeData.__config__.props.value"
                   placeholder="请选择存储字段">
          <el-option label="id"
                     value="id"></el-option>
    ...
    <template v-if="activeData.__config__.dataType === 'dynamic'">
      ...
      <el-form-item label="存储字段">
        <el-input v-model="activeData.__config__.props.value"
                  placeholder="请输入存储字段" />
      </el-form-item>
      <el-form-item label="显示字段">
        <el-input v-model="activeData.__config__.props.label"
                  placeholder="请输入显示字段" />
      </el-form-item>
    </template>
    <el-divider />
    ...
    <el-form-item v-if=" activeData.__config__.optionType === 'default'"
                  label="是否带边框">
