<template>
  <span>
    <el-tooltip :content="$t('common.columnSettings')"
                placement="top">
      <el-link icon="icon-sz icon-sz-options HSZ-common-head-icon"
               :underline="false"
               @click="showDrawer" />
    </el-tooltip>
    <el-drawer title="列表显示设置"
               :visible.sync="drawerVisible"
               :wrapperClosable="false"
               size="320px"
               append-to-body
               class="HSZ-common-drawer columnSettings-drawer">
      <div class="HSZ-flex-main">
        <div class="columnSetting-head">
          <span>表头设置</span>
          <el-link type="primary"
                   :underline="false"
                   @click="reset()">恢复默认</el-link>
        </div>
            ...
            <draggable :list="list"
              ...
              <div class="column-item"
                ...
                <div class="column-item-label">
                  <i class="icon-sz icon-sz-darg column-item-icon"></i>
