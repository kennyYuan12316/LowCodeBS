<template>
  <el-select v-model="valueTitle"
             ...
             :popper-class="`HSZ-select-tree ${themeClass}`"
             @focus="selectFocus"
             :filterable="filterable"
             :filter-method="selectFilter"
             class="HSZ-selectTree"
    ...
    <el-option :value="optionTitle"
      ...
      <p v-show="!options.length"
         class="empty-text">无数据</p>
    </el-option>
  </el-select>
</template>
...
export default {
  ...
  methods: {
    ...
    initScroll () {
      this.$nextTick(() => {
        let list = document.querySelectorAll('.HSZ-select-tree .el-scrollbar .el-select-dropdown__wrap')
        // 有多个下拉框，造成页面错位
