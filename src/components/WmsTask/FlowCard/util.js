...
export class NodeUtils {
  ...
  static isDynamicNode(node) {
    return node && node.type === 'dynamic'
  }
  ...
  //添加动态节点
  static addDynamicNode(data, isBranchAction) {
    // 复用addApprovalNode  因为和审批人基本一致
    this.addApprovalNode(data, isBranchAction, this.createNode('dynamic', data.nodeId))
  }
  /**
